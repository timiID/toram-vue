...
Kekebalan Fisik +10%
Kekebalan Sihir +10%
Kecepatan Item -1.0s`}],Ti="/toram-vue/assets/enhance_weapon_crysta-eGLehiWn.png",Ki="/toram-vue/assets/enhance_armor_crysta-YvncoZmF.png",Ni="/toram-vue/assets/enhance_additional_crysta-mE1Kazx1.png",Gi="/toram-vue/assets/enhace_special_crysta-CIVkxwj2.png";function Y0(e){const t={};return e&&e.split(`
`).map(n=>n.trim()).forEach(n=>{if(!n.match(/[+-]\s*\d/))return;const a=n.match(/^(.+?)\s*([+-])\s*(\d+)(%)?$/);if(!a)return;const[,i,l,s]=a;t[i.trim().toUpperCase()]={sign:l,value:Number(s)}}),t}const Q0={class:"fixed inset-0 pointer-events-none z-0"},q0={key:0,class:"absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-blue-600/10 blur-[120px] rounded-full animate-pulse"},z0={key:1,class:"absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-purple-600/10 blur-[120px] rounded-full animate-pulse",style:{"animation-delay":"2s"}},$0={class:"relative z-10 max-w-[1700px] mx-auto p-4 md:p-10 space-y-0"},Z0={class:"flex items-center gap-1"},X0={class:"text-center md:text-left space-y-1"},ep={class:"flex items-center gap-3"},tp={class:"text-4xl md:text-6xl font-[1000] italic uppercase tracking-tighter leading-none transition-all"},np={class:"flex flex-col items-center md:items-end gap-3"},ap={class:"flex gap-2"},ip={class:"space-y-2 col-span-2 md:col-span-2 lg:col-span-2"},lp={class:"relative group"},op={class:"space-y-2 col-span-1"},sp={class:"relative group"},rp={class:"space-y-0 w-full col-span-2 lg:col-span-3"},cp={class:"flex flex-col md:flex-row items-center gap-3 w-full"},up={class:"relative group w-full"},dp={class:"relative py-4 flex items-center justify-center"},pp={class:"space-y-10 relative z-10 pb-32"},gp={class:"lg:col-span-3 flex flex-row lg:flex-col gap-3 overflow-x-auto lg:overflow-visible pb-2 scroll-hide"},mp=["onClick"],fp={key:1,class:"hidden lg:flex flex-1 items-center justify-center opacity-10"},hp={class:"lg:col-span-6 relative group"},Ap={class:"relative p-6 md:p-10"},bp={class:"flex flex-col md:flex-row gap-8 items-start"},kp={class:"relative shrink-0 mx-auto md:mx-0"},vp=["src","alt"],yp={class:"flex-1 space-y-6 w-full"},xp={class:"space-y-2"},wp={class:"grid grid-cols-1 gap-4"},_p={key:0,class:"w-2 h-2 rounded-full bg-gradient-to-r from-green-500 to-cyan-400 group-hover/item:scale-150 transition-transform flex-shrink-0"},Pp={class:"flex items-center gap-4"},Mp={class:"flex flex-col"},Dp={class:"lg:col-span-3 flex flex-row lg:flex-col gap-3 overflow-x-auto lg:overflow-visible pb-2 scroll-hide"},Rp=["onClick"],Cp={key:1,class:"hidden lg:flex flex-1 items-center justify-center opacity-10"},Sp={key:0,class:"py-40 text-center animate-pulse"},Ep={class:"flex flex-col items-center gap-10 py-20"},Ip={key:0,class:"flex flex-wrap justify-center items-center gap-3"},Bp=["disabled"],Tp={class:"flex gap-2.5 items-center"},Kp=["onClick"],Np={key:1,class:"px-2 font-black text-blue-500"},Gp=["disabled"],Op={class:"flex items-center gap-4 opacity-50"},Lp={class:"text-[10px] font-black text-slate-500 uppercase tracking-[0.4em]"},Fp={class:"fixed bottom-8 left-8 z-[200] hidden lg:block"},Up={__name:"XtallView",props:{isDark:{type:Boolean,default:!0}},setup(e){const t=new Map;function n(B){return t.has(B.code)||t.set(B.code,Y0(B.view)),t.get(B.code)}const a=Jn();function i(){l.value="",s.value=[],r.value=[],m.value="asc",d.value=10,a.push({query:{}})}const l=le(""),s=le([]),r=le([]),c=le(!1),p=le(!1),u=le(1),d=le(10),m=le("asc"),A=le(null),y=le(null),h=Ra(),R=te(()=>{try{return h.query.filter?JSON.parse(h.query.filter):null}catch{return null}}),T=()=>{l.value="",s.value=[],r.value=[],u.value=1},_=B=>{const x=B.type?.toUpperCase();if(x!=="UPGRADE")return J[x]||Ln;const ie=xe(B);return J[`${ie}_UPGRADE`]||Fn},k=B=>({NORMAL:"bg-blue-500/10 text-blue-500 border-blue-500/40",UPGRADE:"bg-purple-500/10 text-purple-500 border-purple-500/40",ADDITIONAL:"bg-yellow-500/10 text-yellow-500 border-yellow-500/40",WEAPON:"bg-red-500/10 text-red-500 border-red-500/40",ARMOR:"bg-green-500/10 text-green-500 border-green-500/40",SPECIAL:"bg-pink-500/10 text-pink-500 border-pink-500/40"})[B?.toUpperCase()]||"bg-slate-500/10 text-slate-500 border-slate-500/40",b=B=>B.link?Ut.find(x=>String(x.code)===String(B.link)):null,H=B=>Ut.filter(x=>String(x.link)===String(B.code)),J={NORMAL:Ln,UPGRADE:Fn,ADDITIONAL:Ei,ADDITIONAL_UPGRADE:Ni,ARMOR:Ii,ARMOR_UPGRADE:Ki,WEAPON:Si,WEAPON_UPGRADE:Ti,SPECIAL:Bi,SPECIAL_UPGRADE:Gi},oe=B=>{if(!B)return null;let x=B,ie=0;for(;x.link&&ie<10;){const fe=Ut.find(W=>String(W.code)===String(x.link));if(!fe)break;x=fe,ie++}return x},xe=B=>oe(B)?.type?.toUpperCase()||"NORMAL",V=B=>{if(!B)return"text-cyan-500";const x=B.type?.toUpperCase();if(x==="UPGRADE"||x==="ENHANCER")return"text-gray-400";const ie=xe(B);return{WEAPON:"text-red-500",ARMOR:"text-green-500",NORMAL:"text-sky-500",ADDITIONAL:"text-yellow-500",SPECIAL:"text-purple-500"}[ie]||"text-cyan-500"},X=B=>B?Array.isArray(B)?B:B.split(/,|\n/).map(x=>x.trim()).filter(x=>x):[],ne=B=>{l.value=B,window.scrollTo({top:0,behavior:"smooth"})},L=te(()=>{let B=Ut.filter(x=>x.name?.trim());if(R.value){const{stats:x,types:ie}=R.value;x&&Object.keys(x).length>0&&(B=B.filter(fe=>{const W=n(fe);return Object.entries(x).every(([_e,ge])=>{const Ie=W[_e.toUpperCase()];return!(!Ie||Ie.sign!==ge.sign||ge.value!==null&&(ge.op===">="&&Ie.value<ge.value||ge.op==="<="&&Ie.value>ge.value))})})),ie&&ie.length>0&&(B=B.filter(fe=>{const W=xe(fe),_e=fe.type==="UPGRADE";return ie.some(ge=>{if(!ge.includes("_"))return!_e&&W===ge;const[Ie,ht]=ge.split("_");return ht==="UPGRADE"&&_e&&W===Ie})}))}if(l.value){const x=l.value.toLowerCase();B=B.filter(ie=>ie.name.toLowerCase().includes(x))}return s.value.length>0&&(B=B.filter(x=>{const ie=xe(x),fe=x.type==="UPGRADE";return s.value.some(W=>{if(!W.includes("_"))return!fe&&ie===W;const[_e,ge]=W.split("_");return ge==="UPGRADE"&&fe&&ie===_e})})),r.value.length>0&&(B=B.filter(x=>{const ie=(x.view||"").toUpperCase();return r.value.every(fe=>ie.includes(fe.toUpperCase()))})),B.sort((x,ie)=>m.value==="asc"?x.name.localeCompare(ie.name):ie.name.localeCompare(x.name))}),ae=te(()=>{const B=(u.value-1)*d.value;return L.value.slice(B,B+d.value)}),Pe=te(()=>Math.ceil(L.value.length/d.value)||1),Le=te(()=>{let B=Math.max(1,u.value-2),x=Math.min(Pe.value,B+4);x-B<4&&(B=Math.max(1,x-4));const ie=[];for(let fe=B;fe<=x;fe++)ie.push(fe);return ie}),we=B=>{A.value&&!A.value.contains(B.target)&&(c.value=!1),y.value&&!y.value.contains(B.target)&&(p.value=!1)};return tn(()=>{window.addEventListener("click",we)}),wi(()=>{window.removeEventListener("click",we)}),Pt([l,s,r,d,m],()=>{u.value=1}),(B,x)=>{const ie=sa("RouterLink"),fe=sa("router-link");return C(),E("div",{class:w(["min-h-screen relative overflow-x-hidden font-sans transition-all duration-700 bg-transparent",e.isDark?"text-slate-200":"text-slate-900"])},[o("div",Q0,[o("div",{class:w(["absolute inset-0 bg-[url('/images/logo.png')] bg-center bg-no-repeat bg-[length:60%_auto] opacity-[0.03] transition-opacity duration-1000",e.isDark?"brightness-200":"invert opacity-[0.02]"])},null,2),x[6]||(x[6]=o("div",{class:"absolute inset-0 bg-gradient-to-b from-transparent to-transparent"},null,-1)),e.isDark?(C(),E("div",q0)):Ce("",!0),e.isDark?(C(),E("div",z0)):Ce("",!0)]),o("div",$0,[o("header",{class:w(["relative group flex flex-col md:flex-row justify-between items-center md:items-end gap-8 pb-10 border-b-2 transition-all duration-500",e.isDark?"border-white/5":"border-black/5"])},[o("div",Z0,[x[9]||(x[9]=o("div",{class:"relative group"},[o("div",{class:"absolute -inset-1 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl blur opacity-25 group-hover:opacity-75 transition duration-1000 group-hover:duration-200"}),o("img",{src:Pa,class:"relative h-16 w-auto object-contain drop-shadow-2xl transition-transform duration-500 group-hover:scale-110",alt:"Logo"})],-1)),o("div",X0,[o("div",ep,[o("h1",tp,[o("span",{class:w(B.text-B.white)},"TIMI ",2),x[7]||(x[7]=o("span",{class:"text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-purple-500 to-red-500"},"DB",-1))]),x[8]||(x[8]=o("div",{class:"px-2 py-0.5 bg-blue-500/10 border border-blue-500/20 rounded text-[8px] font-black text-blue-500 tracking-widest uppercase"},"Bahasa Indonesia",-1))]),o("p",{class:w(["text-xs font-black uppercase tracking-[0.5em] opacity-60",e.isDark?"text-slate-400":"text-slate-500"])},"Toram Online Database",2)])]),o("div",np,[o("div",{class:w(["group relative px-8 py-3 rounded-2xl border-2 overflow-hidden transition-all duration-500",e.isDark?"bg-slate-900/40 border-white/10":"bg-white border-slate-200 shadow-xl shadow-slate-200/50"])},[x[10]||(x[10]=o("div",{class:"absolute inset-0 bg-gradient-to-r from-blue-600/10 to-purple-600/10 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000"},null,-1)),o("span",{class:w(["relative text-xs font-black uppercase tracking-[0.2em]",e.isDark?"text-cyan-400":"text-blue-600"])}," Results : "+N(L.value.length)+" Xtall ",3)],2),o("div",ap,[(C(),E($,null,ce(3,W=>o("div",{key:W,class:"w-8 h-1 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 opacity-20"})),64))])])],2),ye(ie,{to:"/xtall/advanced",class:"mb-6 block w-full rounded-2xl border-2 border-indigo-500 bg-gradient-to-t from-indigo-400 to-purple-500 px-6 py-5 text-center text-lg font-black text-white shadow-xl hover:scale-[1.02] transition"},{default:Xe(()=>[...x[11]||(x[11]=[Ve(" 🔎 Advanced Xtall Search ",-1)])]),_:1}),o("section",{class:w(["grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 p-6 md:p-8 rounded-[3rem] border-2 backdrop-blur-3xl relative z-[100] transition-all duration-500 shadow-2xl",e.isDark?"bg-slate-950/60 border-red/100 shadow-black/40":"bg-red/80 border-slate-200 shadow-slate-300/50"])},[o("div",ip,[x[14]||(x[14]=o("label",{class:"text-[10px] font-black uppercase tracking-[0.2em] text-cyan-500 ml-4 flex items-center gap-2"},[o("span",{class:"w-1.5 h-1.5 rounded-full bg-cyan-500 animate-ping"}),Ve(" Search Name ")],-1)),o("div",lp,[x[12]||(x[12]=o("div",{class:"absolute -inset-0.5 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-2xl blur opacity-0 group-focus-within:opacity-20 transition-opacity duration-500"},null,-1)),ve(o("input",{"onUpdate:modelValue":x[0]||(x[0]=W=>l.value=W),type:"text",placeholder:"Search xtall name...",class:w(["relative w-full pl-12 pr-4 py-4 rounded-2xl border-2 outline-none transition-all font-bold text-sm",e.isDark?"bg-slate-900/50 border-white/5 focus:border-cyan-500 text-white placeholder-slate-600":"bg-white border-slate-200 focus:border-cyan-500 text-slate-800 placeholder-slate-400"])},null,2),[[qe,l.value]]),x[13]||(x[13]=o("svg",{class:"absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-cyan-500 transition-transform group-focus-within:scale-110",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[o("path",{d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z","stroke-width":"3"})],-1))])]),o("div",op,[x[17]||(x[17]=o("label",{class:"text-[10px] font-black uppercase tracking-[0.2em] text-purple-500 ml-4"},"Scale",-1)),o("div",sp,[ve(o("select",{"onUpdate:modelValue":x[1]||(x[1]=W=>d.value=W),class:w(["w-full px-4 py-4 rounded-2xl border-2 outline-none font-bold text-sm appearance-none cursor-pointer transition-all pr-10",e.isDark?"bg-slate-900/50 border-white/5 focus:border-purple-500 text-slate-200":"bg-white border-slate-200 focus:border-purple-500 shadow-sm"])},[...x[15]||(x[15]=[o("option",{value:10},"10 Units",-1),o("option",{value:25},"25 Units",-1),o("option",{value:50},"50 Units",-1),o("option",{value:9999},"Show All",-1)])],2),[[it,d.value]]),x[16]||(x[16]=o("svg",{class:"absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500 pointer-events-none group-hover:rotate-180 transition-transform duration-500",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[o("path",{d:"M19 9l-7 7-7-7","stroke-width":"3"})],-1))])]),o("div",rp,[x[21]||(x[21]=o("div",{class:"flex items-center gap-2 ml-4"},[o("div",{class:"w-1.5 h-4 bg-red-600 rounded-full"}),o("label",{class:"text-[11px] font-[1000] uppercase tracking-[0.25em] text-red-600"}," Sequence & Reset Control Center ")],-1)),o("div",cp,[o("div",up,[ve(o("select",{"onUpdate:modelValue":x[2]||(x[2]=W=>m.value=W),class:w(["w-full h-[60px] px-6 rounded-2xl border-2 outline-none font-bold text-sm appearance-none cursor-pointer transition-all pr-12",e.isDark?"bg-slate-900 border-white/10 focus:border-red-500 text-slate-200":"bg-white border-slate-200 focus:border-red-500 shadow-sm"])},[...x[18]||(x[18]=[o("option",{value:"asc"},"Sequence: A to Z",-1),o("option",{value:"desc"},"Sequence: Z to A",-1)])],2),[[it,m.value]]),x[19]||(x[19]=o("div",{class:"absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none text-red-500"},[o("svg",{class:"w-5 h-5 group-hover:rotate-180 transition-transform duration-500",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[o("path",{d:"M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4","stroke-width":"2.5","stroke-linecap":"round","stroke-linejoin":"round"})])],-1))]),o("button",{onClick:i,class:"h-[60px] w-full px-1 rounded-2xl bg-red-600 hover:bg-red-700 text-white transition-all duration-300 flex items-center justify-center gap-3 shadow-lg shadow-red-600/20 group font-black uppercase tracking-widest text-[10px]"},[...x[20]||(x[20]=[o("svg",{xmlns:"http://www.w3.org/2000/svg",class:"w-4 h-4 group-hover:rotate-180 transition-transform duration-500",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},[o("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"3",d:"M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"})],-1),o("span",{class:"whitespace-nowrap"},"Reset",-1)])])])])],2),o("div",dp,[o("div",{class:w(["absolute inset-0 h-[1px] my-auto",e.isDark?"bg-white/5":"bg-slate-200"])},null,2),x[22]||(x[22]=o("div",{class:"absolute h-[2px] w-[30%] bg-gradient-to-r from-transparent via-blue-500 to-transparent animate-shimmer"},null,-1)),o("div",{class:w(["relative px-6 py-1 rounded-full border-2 text-[8px] font-black uppercase tracking-[0.4em] transition-all",e.isDark?"bg-[#020617] border-white/10 text-slate-500":"bg-transparent-50 border-slate-200 text-slate-400"])}," Xtall Versi Indonesia ",2)]),o("main",pp,[(C(!0),E($,null,ce(ae.value,(W,_e)=>(C(),E("div",{key:W.code,class:"flex flex-col lg:grid lg:grid-cols-12 gap-6 items-stretch animate-entry",style:_t({animationDelay:_e*70+"ms"})},[o("div",gp,[b(W)?(C(),E("div",{key:0,onClick:ge=>ne(b(W).name),class:w(["flex-shrink-0 w-[200px] lg:w-full p-5 rounded-[1.5rem] border-2 cursor-pointer transition-all duration-500 relative overflow-hidden group shadow-xl",e.isDark?"bg-slate-900/300 border-white/65 hover:border-cyan-500/50 hover:bg-slate-900/60":"bg-white border-slate-200 hover:border-cyan-400"])},[x[23]||(x[23]=ta('<div class="absolute left-0 top-0 h-full w-2 bg-gradient-to-b from-sky-400 to cyan-500 to-blue-600 opacity-40 group-hover:opacity-100 transition-opacity" data-v-4ca8d73f></div><div class="flex items-center gap-2 mb-2" data-v-4ca8d73f><svg class="w-3 h-3 text-cyan-500" fill="currentColor" viewBox="0 0 24 24" data-v-4ca8d73f><path d="M11 9l1.42 1.42L8.83 14H18V4h2v12H8.83l3.59 3.58L11 21l-6-6 6-6z" data-v-4ca8d73f></path></svg><span class="text-[9px] font-black uppercase text-cyan-500 tracking-widest" data-v-4ca8d73f>Previous</span></div>',2)),o("p",{class:w(["text-xs font-bold truncate group-hover:translate-x-1 transition-transform duration-300",e.isDark?"text-slate-300":"text-slate-700"])},N(b(W).name),3),x[24]||(x[24]=o("div",{class:"absolute bottom-[-10px] right-[-10px] text-4xl opacity-[0.03] group-hover:scale-125 transition-transform"},"🧬",-1))],10,mp)):(C(),E("div",fp,[...x[25]||(x[25]=[o("div",{class:"w-[2px] h-full bg-gradient-to-b from-transparent via-slate-500 to-transparent"},null,-1)])]))]),o("div",hp,[o("div",{class:w(["absolute -inset-1 rounded-[3rem] blur-2xl opacity-0 group-hover:opacity-20 transition-opacity duration-700",W.type==="UPGRADE"?"bg-purple-600":"bg-blue-600"])},null,2),o("div",{class:w(["h-full relative rounded-[2.5rem] border-2 overflow-hidden transition-all duration-500 shadow-2xl",e.isDark?"bg-[#0b1226]/90 border-white/80 group-hover:border-white/80":"bg-white border-slate-200 group-hover:border-blue-400"])},[o("div",Ap,[o("div",bp,[o("div",kp,[x[26]||(x[26]=o("div",{class:"absolute inset-0 bg-gradient-to-tr from-sky-600 to-purple-600 rounded-[2rem] blur-xl opacity-20 group-hover:opacity-40 animate-pulse"},null,-1)),o("div",{class:w(["relative w-24 h-24 md:w-32 md:h-32 rounded-[2.5rem] border-2 flex items-center justify-center shadow-inner transition-all duration-700 group-hover:rotate-[10deg] group-hover:scale-110",e.isDark?"bg-slate-950 border-white/70":"bg-slate-50 border-slate-200"])},[o("img",{src:_(W),class:"w-16 h-16 md:w-20 md:h-20 object-contain drop-shadow-[0_15px_15px_rgba(0,0,0,0.4)]",alt:W.type},null,8,vp)],2),o("div",{class:w(["absolute -bottom-2 -right-2 w-10 h-10 rounded-2xl border-2 flex items-center justify-center text-[10px] font-black",k(W.type)])},N(W.type.charAt(0)),3)]),o("div",yp,[o("div",xp,[x[27]||(x[27]=o("div",{class:"flex flex-wrap items-center gap-3"},null,-1)),o("h3",{class:w(["text-2xl md:text-4xl font-[1000] tracking-tighter leading-none transition-all duration-500 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-blue-400 group-hover:to-purple-400",V(W)])},N(W.name),3)]),o("div",{class:w(["p-6 rounded-3xl border-2 transition-all duration-500 group-hover:scale-[1.02]",e.isDark?"bg-white/[0.02] border-white/5 group-hover:bg-white/[0.04]":"bg-slate-50 border-slate-100"])},[o("div",wp,[(C(!0),E($,null,ce(X(W.view),(ge,Ie)=>(C(),E("div",{key:Ie,class:"flex items-center gap-4 group/item"},[ge.includes("Dengan")?Ce("",!0):(C(),E("div",_p)),o("p",{class:w(["text-xs md:text-sm font-bold tracking-tight transition-all duration-300",ge.includes("Dengan")?"text-green-500 italic":ge.includes("-")?"text-red-500":e.isDark?"text-slate-300 group-hover/item:text-white":"text-slate-600 group-hover/item:text-slate-900"])},N(ge),3)]))),128))])],2)])])]),o("div",{class:w(["px-8 py-5 border-t-2 flex flex-col sm:flex-row justify-between items-center gap-4",e.isDark?"bg-white/[0.02] border-white/5":"bg-slate-50 border-slate-100"])},[o("div",Pp,[o("div",Mp,[o("span",{class:w(["text-[10px] font-black tracking-widest transition-colors",e.isDark?"text-slate-400":"text-slate-500"])}," TYPE XTALL ",2),o("span",{class:w(["text-[9px] font-black px-2.5 py-0.5 rounded-full border transition-all uppercase tracking-tighter",k(W.type)])},N(W.type),3)]),x[28]||(x[28]=o("div",{class:"h-8 w-[1px] bg-white/10 hidden sm:block"},null,-1))]),ye(fe,{to:"/xtall/"+W.code,class:"w-full sm:w-auto px-6 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-[10px] font-black uppercase tracking-widest shadow-lg shadow-blue-600/20 hover:shadow-blue-600/40 hover:-translate-y-0.5 transition-all duration-300 text-center"},{default:Xe(()=>[...x[29]||(x[29]=[Ve(" Details ",-1)])]),_:1},8,["to"])],2)],2)]),o("div",Dp,[H(W).length?(C(!0),E($,{key:0},ce(H(W),ge=>(C(),E("div",{key:ge.code,onClick:Ie=>ne(ge.name),class:w(["flex-shrink-0 w-[200px] lg:w-full p-5 rounded-[1.5rem] border-2 cursor-pointer transition-all duration-500 relative overflow-hidden group shadow-xl",e.isDark?"bg-slate-900/30 border-white/65 hover:border-purple-500/50 hover:bg-slate-900/60":"bg-white border-slate-200 hover:border-purple-400"])},[x[30]||(x[30]=ta('<div class="absolute right-0 top-0 h-full w-2 bg-gradient-to-b from-purple-400 to-pink-600 to-yellow-700 opacity-40 group-hover:opacity-100 transition-opacity" data-v-4ca8d73f></div><div class="flex items-center justify-end gap-2 mb-2 text-right" data-v-4ca8d73f><span class="text-[9px] font-black uppercase text-purple-500 tracking-widest" data-v-4ca8d73f>Next Upgrade</span><svg class="w-3 h-3 text-purple-500 rotate-180" fill="currentColor" viewBox="0 0 24 24" data-v-4ca8d73f><path d="M11 9l1.42 1.42L8.83 14H18V4h2v12H8.83l3.59 3.58L11 21l-6-6 6-6z" data-v-4ca8d73f></path></svg></div>',2)),o("p",{class:w(["text-xs font-bold truncate text-right group-hover:-translate-x-1 transition-transform duration-300",e.isDark?"text-slate-300":"text-slate-700"])},N(ge.name),3),x[31]||(x[31]=o("div",{class:"absolute bottom-[-10px] left-[-10px] text-4xl opacity-[0.03] group-hover:scale-125 transition-transform"},"🚀",-1))],10,Rp))),128)):(C(),E("div",Cp,[...x[32]||(x[32]=[o("div",{class:"w-[2px] h-full bg-gradient-to-b from-transparent via-slate-500 to-transparent"},null,-1)])]))])],4))),128)),L.value.length===0?(C(),E("div",Sp,[x[33]||(x[33]=ta('<div class="inline-flex relative mb-8" data-v-4ca8d73f><div class="absolute inset-0 bg-blue-500 blur-3xl opacity-20 animate-ping" data-v-4ca8d73f></div><div class="text-8xl relative" data-v-4ca8d73f>🔎</div></div><h2 class="text-3xl font-[1000] uppercase italic tracking-tighter" data-v-4ca8d73f>Xtall not found</h2><p class="text-slate-500 font-bold uppercase tracking-[0.3em] text-xs mt-4" data-v-4ca8d73f>Search xtall name with correct Indonesian name.</p>',3)),o("button",{onClick:T,class:"mt-8 px-8 py-3 bg-white/5 hover:bg-white/10 border border-blue/10 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all"},"Reset")])):Ce("",!0),o("div",Ep,[Pe.value>1&&d.value<1e3?(C(),E("nav",Ip,[o("button",{onClick:x[3]||(x[3]=W=>u.value--),disabled:u.value===1,class:"w-14 h-14 flex items-center justify-center rounded-2xl border-2 font-black disabled:opacity-30 transition-all duration-300 shadow-sm isDark ? 'bg-slate-900 border-white/10 text-slate-400 hover:border-blue-500 hover:text-blue-500' : 'bg-white border-slate-200 text-slate-400 hover:border-blue-500 hover:text-blue-500'"}," « ",8,Bp),o("div",Tp,[(C(!0),E($,null,ce(Le.value,W=>(C(),E($,{key:W},[W!=="..."?(C(),E("button",{key:0,onClick:_e=>u.value=W,class:w(["w-14 h-14 rounded-2xl font-black text-lg transition-all duration-300 border-2 flex items-center justify-center",u.value===W?"bg-blue-600 border-blue-600 text-white shadow-[0_10px_25px_rgba(37,99,235,0.4)] scale-110 -translate-y-1":e.isDark?"bg-slate-900 border-white/5 text-blue-500 hover:border-blue-500":"bg-white border-slate-100 text-blue-600 hover:border-blue-200 shadow-sm"])},N(W),11,Kp)):(C(),E("span",Np,"..."))],64))),128))]),o("button",{onClick:x[4]||(x[4]=W=>u.value++),disabled:u.value===Pe.value,class:"w-14 h-14 flex items-center justify-center rounded-2xl border-2 font-black disabled:opacity-30 transition-all duration-300 shadow-sm isDark ? 'bg-slate-900 border-white/10 text-slate-400 hover:border-blue-500 hover:text-blue-500' : 'bg-white border-slate-200 text-slate-400 hover:border-blue-500 hover:text-blue-500'"}," » ",8,Gp)])):Ce("",!0),d.value<100?(C(),E("button",{key:1,onClick:x[5]||(x[5]=W=>d.value=9999),class:"group relative px-10 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl overflow-hidden transition-all duration-500 hover:scale-105 hover:shadow-[0_15px_40px_rgba(37,99,235,0.4)] shadow-xl"},[...x[34]||(x[34]=[o("div",{class:"absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300"},null,-1),o("span",{class:"relative text-xs font-[1000] text-white uppercase tracking-[0.3em] italic"},"Explore All",-1)])])):Ce("",!0),o("div",Op,[x[35]||(x[35]=o("div",{class:"h-[1px] w-12 bg-blue-500/30"},null,-1)),o("p",Lp,"Page "+N(u.value)+" of "+N(Pe.value),1),x[36]||(x[36]=o("div",{class:"h-[1px] w-12 bg-blue-500/30"},null,-1))])])])]),o("div",Fp,[o("div",{class:w(["px-6 py-3 rounded-2xl border-2 backdrop-blur-xl transition-all duration-500",e.isDark?"bg-slate-900/80 border-white/10":"bg-white/80 border-slate-200 shadow-2xl"])},[...x[37]||(x[37]=[o("div",{class:"flex items-center gap-4"},[o("div",{class:"w-2 h-2 rounded-full bg-blue-500 animate-pulse"}),o("span",{class:"text-[9px] font-black uppercase tracking-widest opacity-60"},"Versi Nama Indonesia")],-1)])],2)])],2)}}},Hp=Wt(Up,[["__scopeId","data-v-4ca8d73f"]]),Wl=310,Wa={"Custom Experience Value":0,"Nightmare Crystal (Stack)":297e3,"Lapin's Soul (Piece)":344e3,"Parasited Crystal (Stack)":38e4,"Free from Infesters! (2k f/k)":15e6,"Defeat Metal Stinger (x100)":324e4,"Minotaur Skin (Stack)":999900,"Cracked Platinum Armguard (Stack)":677e3},Ja={"Chapter 1":"","First Time Visit":30,"Straye Brother and Sister":80,"A Golem on a Rampage":730,"The Goddess of Wisdom":2050,"The Dragon's Den":4700,"The Ruined Temple":9330,"The First Magic Stone":16700,"Purification Incense":27900,"The Dragon and Black Crystal":43e3,"Chapter 2":"","The Merchant Girl":64e3,"Where Are the Gems?":92e3,"Who is the Black Knight?!":118200,"Trials in the Palace":149e3,"The Moon Wizard":172e3,"The Follower and Hater":227e3,"The Wizard's Cave":24e4,"The Star Wizard":255e3,"Chapter 3":"","The Invincible... Enemy??":27e4,"The Ancient Empress":284e3,"The Culprit":319e3,"Fate of the Fortress":335e3,"Memory in the Lost Town":398e3,"The Stolen Sorcery Gem":417e3,"Living with a Dragon":462300,"Monsters from Outerworld":54e4,"Chapter 4":"","The Mage Diels":562e3,"Journey for Reconstruction":585e3,"The Sacred Gem in Akaku":71e4,"The King of Darkan":74e4,"The Lurking Evil":803e3,"Find the False Black Knight!":913e3,"Technista's Movement":1e6,"The Falling Feather of Death":11e5,"Chapter 5":"","In The Unknown Darkness":115e4,"The Charm":131e4,"Parching Dark Mirror":137e4,"Fierce Battle in the Garden":155e4,"A Light in the Darkness":175e4,"The Ones Nesting in the Manor":197e4,"The Dark Castle":221e4,"To The Living World":222e4,"Chapter 6":"","Demi Machina":26e5,"The Town of Pax Faction":27e5,"Mechanical Heart":28e5,"Black Knights of Lyark":282e4,"The Mysterious Artifact":303e4,"Truth of the Artifact":3099e3,"The Price of Treachery":332e4,"The Blasphemous Factory":364e4,"Mystery of the Black Knights":402e4,"Chapter 7":"","Monster's Forest":473e4,"The Underground Town":482e4,"The Elves in Lyark":507e4,"The Mad Laboratory":55e5,"Tragedy in the Jail":6e6,"Calamity in Droma Square":64e5,"Head for Ultimea Palace":69e5,"The Chaotic Truth":74e5,"Chapter 8":"","The Mine Where Monsters Lurk":84e5,"The Mysterious Shadow":85e5,"The New Diel Country":86e5,"The Ruins of the Gods":88e5,"The Former God of Justice":91e5,"The Remaining Thrones in the Shrine":97e5,"Gods' Whereabouts":104e5,"The Wait at Specia's Shrine":111e5,"The Warden of Ice & Snow":118e5,"At Mountains' End":125e5,"Chapter 9":"","Deadly Road to Eldenbaum":158e5,"Unforeseen Traps":171e5,"Traces of Technological Progress":182e5,"An Unexpected Acquaintance":192e5,"Front Line Base Operation":203e5,"Strategy to Redeem the Treetop Harbor":215e5,"The Teleporter Left Behind":227e5,"The Man Who Seeks Death":239e5,"The Battle to Recapture Eldenbaum":25e6,"A New Beginning":13e6,"Chapter 10":"","Off to the Fateful Land":26e6,"The Inhabitants Under the Cliff":274e5,"The Nightmare Returns":288e5,"The Whereabouts of the Missing Monks":302e5,"The Goddess of Justice and the Squatters":316e5,"Navigator of the Ark":331e5,"Witch in the Woods":346e5,"The Duel in Nov Diela":362e5,"Chapter 11":"","Flying the Ark":378e5,"Land of the Unknown":49e6,"The Strolling Forest":51e6,"Eumanos the Forest Dwellers":534e5,"A Sproutling is Born":557e5,"The Blessing-Bearer":581e5,"Intense Battle in Coenubia's Stronghold":605e5,"The Shadow of a Smoky Mountain":63e6,"The Weredragons & the Underground World":655e5,"Chapter 12":"","The Sky with a Ceiling":734e5,"Rivalry Between Dragons and Weredragons":763e5,"Weredragon Couple and a Baby":793e5,"Weredragons' Vital Point":823e5,"Intense Battle in Propulsion System":853e5,"Discovering a New Technology":442e5,"Ark Repair":927e5,"Weredragon Dispute":96e6,"Cocoon in the Ice Wall":993e5,"Chapter 13":"","Underwater Inhabitants":1126e5,"Water Dome":1165e5,"Underwater City":602e5,"The Thing in the Abandoned District":1258e5,"Shadow from the Abyss":1299e5,"The Ruthless Council":67e6,"Mysterious Entity in the Little Shrine":1399e5,"The Great Battle Underwater":1442e5,"Chapter 14":"","Crisis in the Sky":1591e5,"The Surviving Siblings":164e6,"Chaotic Situation":1689e5,"The Bitter Truth":1738e5,"The Uncouth Rana Prince":1788e5,"Mutant Coenubia Village":1839e5,"Fierce Battle with Mutant Lixis":189e6,"Chapter 15":"","Ark Crisis":2105e5,"Coastal Clash":2163e5,"Unda's Rescue Operation":2222e5},Lt=e=>Math.floor(.025*Math.pow(e,4)+2*e),jp=(e,t,n)=>{let a=Math.floor((1-t/100)*Lt(e));for(let i=e+1;i<n;i++)a+=Lt(i);return a},Va=(e,t,n)=>{let a=n,i=(1-t/100)*Lt(e);if(n<i){let l=t/100*Lt(e)+n;return[e,Math.floor(100*l/Lt(e))]}else{a-=i;let l=e+1;for(;Lt(l)<=a;)a-=Lt(l),l+=1;let s=Math.floor(100*a/Lt(l));return[l,s]}},Wp={class:"space-y-8 animate-in fade-in duration-700 max-w-6xl mx-auto pb-20 px-4"},Jp={class:"flex flex-col items-center gap-6 animate-bounce-slow"},Vp={class:"grid grid-cols-1 lg:grid-cols-3 gap-8"},Yp={class:"lg:col-span-2 space-y-6"},Qp={class:"grid grid-cols-1 md:grid-cols-3 gap-6 mb-8"},qp={class:"group"},zp={class:"group"},$p={class:"group"},Zp={key:0,class:"space-y-8 animate-in slide-in-from-top-2"},Xp={class:"grid grid-cols-1 md:grid-cols-2 gap-6 pt-8 border-t border-white/10"},eg={class:"relative group select-container"},tg={class:"relative"},ng=["value"],ag={class:"relative group select-container"},ig={class:"relative"},lg=["value"],og={class:"flex flex-wrap gap-8 ml-2"},sg={class:"flex items-center gap-3 cursor-pointer group active:scale-95 transition-transform"},rg={class:"flex items-center gap-3 cursor-pointer group active:scale-95 transition-transform"},cg={key:1,class:"space-y-8 animate-in slide-in-from-top-2"},ug={class:"grid grid-cols-1 md:grid-cols-2 gap-6 pt-8 border-t border-white/10"},dg={class:"relative group select-container"},pg={class:"relative"},gg=["value"],mg={class:"lg:col-span-1"},fg={class:"space-y-6 sticky top-8"},hg={class:"relative z-10 space-y-8"},Ag={class:"result-item"},bg={class:"text-2xl font-black tabular-nums tracking-tighter"},kg={class:"pt-8 border-t border-white/20 result-item"},vg={class:"text-[10px] font-black tracking-widest opacity-60 uppercase mb-2"},yg={class:"flex items-baseline gap-2"},xg={class:"text-6xl font-black italic tracking-tighter drop-shadow-lg block"},wg={class:"text-xl font-bold opacity-70"},_g={class:"bg-black/20 p-4 rounded-2xl border border-white/10 backdrop-blur-sm result-item"},Pg={class:"text-sm font-black tabular-nums tracking-wide"},Mg={class:"absolute -right-6 -bottom-6 text-[12rem] font-black italic opacity-10 pointer-events-none uppercase tracking-tighter transition-transform duration-700 deco-text"},Dg={class:"space-y-2 max-h-[300px] overflow-y-auto pr-2 custom-scroll"},Rg={class:"text-[11px] font-black opacity-40"},Cg={class:"text-right"},Sg={class:"text-[10px] font-bold opacity-50 ml-1"},Eg={__name:"CalculatorMQ",props:{isDark:Boolean},setup(e){const t=le("mq"),n=le(1),a=le(0),i=le(Wl),l=le(!0),s=le(!1),r=Object.keys(Ja),c=le(1),p=le(r.length-1),u=le(Object.keys(Wa)[1]),d=le(1),m=te(()=>{let y=[],h=0;return r.forEach((R,T)=>{R.startsWith("Chapter")?h++:Ja[R]!==""&&y.push({id:T,label:`CH${h} - ${R}`})}),y}),A=te(()=>{const y=Number(n.value)||1,h=Number(a.value)||0,R=Number(i.value)||Wl,T=jp(y,h,R);let _=0;for(let V=c.value;V<=p.value;V++){const X=Ja[r[V]];typeof X=="number"&&(_+=X),r[V].includes("Coenubia")&&!l.value&&(_+=125e5)}const[k,b]=Va(y,h,_);let H=[];if(s.value&&_>0){let V=y,X=h;for(let ne=1;ne<=20;ne++){const[L,ae]=Va(V,X,_);if(H.push({run:ne,lv:L,p:ae}),V=L,X=ae,V>=R)break}}const J=(Wa[u.value]||0)*(d.value||0),[oe,xe]=Va(y,h,J);return{xpNeeded:T,totalMqXP:_,resLv:k,resP:b,diaryRuns:H,sqLv:oe,sqPercent:xe,sqXP:J}});return(y,h)=>(C(),E("div",Wp,[o("div",Jp,[h[11]||(h[11]=o("div",{class:"text-center"},[o("h1",{class:"text-5xl md:text-6xl font-black italic tracking-tighter uppercase text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 drop-shadow-2xl"}," MQ Calculator "),o("p",{class:"text-[10px] font-bold opacity-50 tracking-[0.4em] uppercase animate-pulse"},"Timi DB System")],-1)),o("div",{class:w(["p-1 rounded-full flex gap-1 border backdrop-blur-md transition-all shadow-xl",e.isDark?"bg-white/5 border-white/10":"bg-slate-200/50 border-slate-300"])},[o("button",{onClick:h[0]||(h[0]=R=>t.value="mq"),class:w(["tab-btn",t.value==="mq"?"tab-active":""])},"Main Quest",2),o("button",{onClick:h[1]||(h[1]=R=>t.value="npc"),class:w(["tab-btn",t.value==="npc"?"tab-active":""])},"NPC Quest",2)],2)]),o("div",Vp,[o("div",Yp,[o("div",{class:w(["p-8 rounded-[2.5rem] border backdrop-blur-md shadow-2xl transition-all duration-500",e.isDark?"bg-slate-900/40 border-white/10":"bg-white/60 border-white/40"])},[o("div",Qp,[o("div",qp,[h[12]||(h[12]=o("label",{class:"label-text"},"Current Lv",-1)),ve(o("input",{"onUpdate:modelValue":h[2]||(h[2]=R=>n.value=R),type:"number",class:w(["input-style",e.isDark?"dark-input":"light-input"])},null,2),[[qe,n.value,void 0,{number:!0}]])]),o("div",zp,[h[13]||(h[13]=o("label",{class:"label-text"},"Percent %",-1)),ve(o("input",{"onUpdate:modelValue":h[3]||(h[3]=R=>a.value=R),type:"number",class:w(["input-style",e.isDark?"dark-input":"light-input"])},null,2),[[qe,a.value,void 0,{number:!0}]])]),o("div",$p,[h[14]||(h[14]=o("label",{class:"label-text text-pink-500"},"Target Lv",-1)),ve(o("input",{"onUpdate:modelValue":h[4]||(h[4]=R=>i.value=R),type:"number",class:w(["input-style",e.isDark?"dark-input":"light-input"])},null,2),[[qe,i.value,void 0,{number:!0}]])])]),t.value==="mq"?(C(),E("div",Zp,[o("div",Xp,[o("div",eg,[h[16]||(h[16]=o("label",{class:"label-text text-indigo-400"},"Start From",-1)),o("div",tg,[ve(o("select",{"onUpdate:modelValue":h[5]||(h[5]=R=>c.value=R),class:w(["input-style custom-select pr-10",e.isDark?"dark-input":"light-input"])},[(C(!0),E($,null,ce(m.value,R=>(C(),E("option",{key:R.id,value:R.id,class:"dropdown-item"},N(R.label),9,ng))),128))],2),[[it,c.value]]),h[15]||(h[15]=o("div",{class:"select-arrow text-indigo-500"},[o("svg",{xmlns:"http://www.w3.org/2000/svg",class:"h-4 w-4",viewBox:"0 0 20 20",fill:"currentColor"},[o("path",{"fill-rule":"evenodd",d:"M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z","clip-rule":"evenodd"})])],-1))])]),o("div",ag,[h[18]||(h[18]=o("label",{class:"label-text text-indigo-400"},"End At",-1)),o("div",ig,[ve(o("select",{"onUpdate:modelValue":h[6]||(h[6]=R=>p.value=R),class:w(["input-style custom-select pr-10",e.isDark?"dark-input":"light-input"])},[(C(!0),E($,null,ce(m.value,R=>(C(),E("option",{key:R.id,value:R.id,class:"dropdown-item"},N(R.label),9,lg))),128))],2),[[it,p.value]]),h[17]||(h[17]=o("div",{class:"select-arrow text-indigo-500"},[o("svg",{xmlns:"http://www.w3.org/2000/svg",class:"h-4 w-4",viewBox:"0 0 20 20",fill:"currentColor"},[o("path",{"fill-rule":"evenodd",d:"M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z","clip-rule":"evenodd"})])],-1))])])]),o("div",og,[o("label",sg,[ve(o("input",{type:"checkbox","onUpdate:modelValue":h[7]||(h[7]=R=>l.value=R),class:"w-5 h-5 rounded border-indigo-500 accent-indigo-600 cursor-pointer"},null,512),[[_l,l.value]]),h[19]||(h[19]=o("span",{class:"text-[11px] font-black uppercase tracking-widest opacity-70 group-hover:opacity-100 transition-opacity"},"Skip Pre-Venena",-1))]),o("label",rg,[ve(o("input",{type:"checkbox","onUpdate:modelValue":h[8]||(h[8]=R=>s.value=R),class:"w-5 h-5 rounded border-purple-500 accent-purple-600 cursor-pointer"},null,512),[[_l,s.value]]),h[20]||(h[20]=o("span",{class:"text-[11px] font-black uppercase tracking-widest opacity-70 group-hover:opacity-100 transition-opacity"},"Spam Diaries",-1))])])])):(C(),E("div",cg,[o("div",ug,[o("div",dg,[h[22]||(h[22]=o("label",{class:"label-text text-emerald-400"},"Select Quest",-1)),o("div",pg,[ve(o("select",{"onUpdate:modelValue":h[9]||(h[9]=R=>u.value=R),class:w(["input-style custom-select pr-10",e.isDark?"dark-input":"light-input"])},[(C(!0),E($,null,ce(Ge(Wa),(R,T)=>(C(),E("option",{key:T,value:T,class:"dropdown-item"},N(T),9,gg))),128))],2),[[it,u.value]]),h[21]||(h[21]=o("div",{class:"select-arrow text-emerald-500"},[o("svg",{xmlns:"http://www.w3.org/2000/svg",class:"h-4 w-4",viewBox:"0 0 20 20",fill:"currentColor"},[o("path",{"fill-rule":"evenodd",d:"M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z","clip-rule":"evenodd"})])],-1))])]),o("div",null,[h[23]||(h[23]=o("label",{class:"label-text text-emerald-400"},"Amount (Stack/Times)",-1)),ve(o("input",{"onUpdate:modelValue":h[10]||(h[10]=R=>d.value=R),type:"number",class:w(["input-style",e.isDark?"dark-input":"light-input"])},null,2),[[qe,d.value,void 0,{number:!0}]])])])]))],2)]),o("div",mg,[o("div",fg,[o("div",{class:w(["p-8 rounded-[3rem] shadow-2xl text-white relative overflow-hidden flex flex-col justify-between transition-all duration-500 result-card-interactive",t.value==="mq"?"bg-gradient-to-br from-indigo-600 to-purple-800 shadow-indigo-500/30":"bg-gradient-to-br from-emerald-600 to-teal-800 shadow-emerald-500/30"])},[o("div",hg,[o("div",Ag,[h[24]||(h[24]=o("p",{class:"text-[10px] font-black tracking-widest opacity-60 uppercase mb-1"},"XP Required to Target",-1)),o("h3",bg,N(A.value.xpNeeded.toLocaleString()),1)]),o("div",kg,[o("p",vg,N(t.value==="mq"?"Result After 1 Run":"Result After Turn-in"),1),o("div",yg,[o("span",xg," Lv "+N(t.value==="mq"?A.value.resLv:A.value.sqLv),1),o("span",wg,N(t.value==="mq"?A.value.resP:A.value.sqPercent)+"% ",1)])]),o("div",_g,[h[25]||(h[25]=o("p",{class:"text-[9px] font-bold opacity-50 uppercase tracking-widest mb-1"},"Total XP Gained",-1)),o("p",Pg,N((t.value==="mq"?A.value.totalMqXP:A.value.sqXP).toLocaleString())+" XP ",1)])]),o("div",Mg,N(t.value),1)],2),t.value==="mq"&&s.value&&A.value.diaryRuns.length>0?(C(),E("div",{key:0,class:w(["p-6 rounded-[2.5rem] border backdrop-blur-md animate-in slide-in-from-bottom-4",e.isDark?"bg-white/5 border-white/10":"bg-white border-slate-200 shadow-lg"])},[h[26]||(h[26]=o("p",{class:"text-[10px] font-black uppercase tracking-widest opacity-50 mb-4 px-2"},"Diary Projection",-1)),o("div",Dg,[(C(!0),E($,null,ce(A.value.diaryRuns,R=>(C(),E("div",{key:R.run,class:"flex justify-between items-center p-3 rounded-xl hover:bg-indigo-500/10 transition-colors"},[o("span",Rg,"RUN #"+N(R.run),1),o("div",Cg,[o("span",{class:w(["font-black",e.isDark?"text-white":"text-slate-800"])},"Lv "+N(R.lv),3),o("span",Sg,N(R.p)+"%",1)])]))),128))])],2)):Ce("",!0)])])])]))}},Ig=Wt(Eg,[["__scopeId","data-v-c84703e0"]]),Bg=280,Jl=54,Tg=55,Vl=265,Kg=300,Bt=510,Tt=277,{floor:Be,min:Ng,max:Gg}=Math,Og=(e,t,n,a,i)=>{const l=Be(n*(100+(i||0))/100+(a||0));return(e||0)+Be((t||0)/2)+Be(l/6)},Lg=(e,t,n,a,i,l)=>{const s=Be(a*(100+(l||0))/100+(i||0)),r=(50+5*(e||0))/100,c=10+(t||0)-(n||0)+Be(s/10);return Ng(100,Gg(0,Be(r*c)))},Fg=(e,t,n,a,i)=>{let l=Be((e||0)*(1+(t||0)*.01+(n||0)*.02));const s=i;switch(a){case"Armor":l+=Be(s.VIT/10);break;case"1H Sword":case"Bow":l+=Be((s.DEX+s.STR)/20);break;case"2H Sword":l+=Be(s.STR/10);break;case"Bowgun":l+=Be(s.DEX/10);break;case"Staff":l+=Be(s.INT/10);break;case"Magic Device":l+=Be((s.INT+s.AGI)/20);break;case"Knuckle":l+=Be(s.AGI/10);break;case"Halberd":l+=Be((s.STR+s.AGI)/20);break;case"Katana":l+=Be((s.DEX+s.AGI)/20);break}return l},Ug={class:"relative z-10 w-full max-w-6xl mx-auto p-4 md:p-8 space-y-8"},Hg={class:"grid grid-cols-1 lg:grid-cols-12 gap-6 items-start"},jg={class:"lg:col-span-4 space-y-6 animate-float"},Wg={class:"grid grid-cols-2 gap-x-4 gap-y-5"},Jg={class:"block text-[9px] font-black text-slate-500 uppercase mb-1.5 ml-1"},Vg=["onUpdate:modelValue"],Yg={class:"mt-8 pt-6 border-t dark:border-white/5 border-slate-100 grid grid-cols-2 gap-3"},Qg={class:"block text-[8px] font-black text-slate-500 uppercase mb-1 ml-1"},qg=["onUpdate:modelValue"],zg={class:"lg:col-span-4 space-y-6"},$g={class:"space-y-4"},Zg={class:"relative group select-container"},Xg={class:"relative overflow-hidden rounded-xl"},em=["value"],tm={class:"grid grid-cols-2 gap-4"},nm={class:"group"},am={class:"group"},im={class:"space-y-3 pt-2"},lm={class:"text-[9px] font-black text-slate-500 uppercase tracking-tighter group-hover:text-cyan-200"},om=["onUpdate:modelValue"],sm={class:"lg:col-span-4 space-y-6 animate-float-slow"},rm={class:"flex items-baseline gap-2"},cm={class:"mt-6 w-full bg-slate-500/10 h-3 rounded-full overflow-hidden p-[2px]"},um={class:"flex items-baseline gap-2"},dm={class:"text-8xl font-black italic tracking-tighter leading-none dark:text-white text-slate-900 hover:scale-105 transition-transform duration-700 block"},pm={class:"space-y-4"},gm={class:"flex justify-between items-center text-[10px] font-black text-slate-500 uppercase border-b border-white/5 pb-3"},mm={key:0,class:"flex flex-col items-center justify-center gap-2 p-6 bg-rose-500/5 border border-rose-500/20 rounded-[2rem] text-rose-500 animate-shake shadow-[inset_0_0_20px_rgba(244,63,94,0.05)]"},fm={key:1,class:"group flex flex-col items-center justify-center gap-2 p-6 bg-gradient-to-br from-emerald-500/10 to-transparent border-2 border-emerald-500/20 rounded-[2rem] text-emerald-400 animate-pulse transition-all hover:border-emerald-500/50"},hm={__name:"BSCalculator",props:["isDark"],setup(e){const t=e,n=te(()=>["p-8 rounded-[2.5rem] border backdrop-blur-3xl transition-all duration-500",t.isDark?"bg-slate-950/60 border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)]":"bg-white/80 border-slate-200 shadow-xl"]),a=["Armor","1H Sword","2H Sword","Bow","Bowgun","Staff","Magic Device","Knuckle","Halberd","Katana"],i=hn({level:305,craftType:"Armor",stats:{STR:0,INT:0,VIT:0,DEX:0,AGI:0,TEC:0},eStr:0,eStrP:0,eDex:0,eDexP:0,prof:Bg,createSkill:10,itemDiff:Vl,basePot:Jl,careful:10,expert:10}),l=()=>{Object.keys(i.stats).forEach(p=>i.stats[p]=0),i.craftType==="Armor"?(i.stats.VIT=Bt,i.stats.TEC=Tt,i.itemDiff=Vl,i.basePot=Jl):(i.itemDiff=Kg,i.basePot=Tg,["1H Sword","Bow","Bowgun"].includes(i.craftType)?(i.stats.DEX=Bt,i.stats.STR=Tt):i.craftType==="2H Sword"?(i.stats.STR=Bt,i.stats.DEX=Tt):i.craftType==="Staff"?(i.stats.INT=Bt,i.stats.TEC=Tt):i.craftType==="Magic Device"?(i.stats.INT=Bt,i.stats.AGI=Tt):i.craftType==="Knuckle"?(i.stats.AGI=Bt,i.stats.DEX=Tt):i.craftType==="Halberd"?(i.stats.STR=Bt,i.stats.AGI=Tt):i.craftType==="Katana"&&(i.stats.DEX=Bt,i.stats.AGI=Tt))};tn(()=>l());const s=te(()=>Og(i.prof,i.stats.TEC,i.stats.DEX,i.eDex,i.eDexP)),r=te(()=>Lg(i.createSkill,s.value,i.itemDiff,i.stats.STR,i.eStr,i.eStrP)),c=te(()=>Fg(i.basePot,i.careful,i.expert,i.craftType,i.stats));return(p,u)=>(C(),E("div",Ug,[u[17]||(u[17]=o("div",{class:"text-center py-4 animate-bounce-slow"},[o("h1",{class:"text-6xl font-black italic tracking-tighter uppercase text-transparent bg-clip-text bg-gradient-to-r from-slate-100 via-orange-400 to-slate-500 dark:from-white dark:via-orange-500 dark:to-slate-600 drop-shadow-[0_10px_10px_rgba(0,0,0,0.3)]"}," Blacksmith Calculator "),o("p",{class:"text-[10px] font-bold uppercase tracking-[0.5em] text-orange-500 mt-2 animate-pulse"},"Timi DB")],-1)),o("div",Hg,[o("div",jg,[o("div",{class:w(n.value)},[u[3]||(u[3]=o("p",{class:"text-[10px] font-black uppercase tracking-widest text-orange-500/60 mb-6 border-b border-orange-500/10 pb-2"},"Character Parameters",-1)),o("div",Wg,[(C(!0),E($,null,ce(i.stats,(d,m)=>(C(),E("div",{key:m,class:"transition-all hover:scale-105"},[o("label",Jg,N(m),1),ve(o("input",{type:"number","onUpdate:modelValue":A=>i.stats[m]=A,class:"w-full bg-slate-500/5 border dark:border-white/10 border-slate-200 rounded-xl p-3 text-center font-black dark:text-white text-slate-900 outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all"},null,8,Vg),[[qe,i.stats[m],void 0,{number:!0}]])]))),128))]),o("div",Yg,[(C(),E($,null,ce([["eStr","STR+"],["eStrP","STR%"],["eDex","DEX+"],["eDexP","DEX%"]],d=>o("div",{key:d[0]},[o("label",Qg,N(d[1]),1),ve(o("input",{type:"number","onUpdate:modelValue":m=>i[d[0]]=m,class:"w-full bg-orange-500/5 border dark:border-white/5 border-slate-200 rounded-lg p-2 text-center text-xs font-black text-orange-500 outline-none hover:shadow-[0_0_15px_rgba(249,115,22,0.2)] transition-all"},null,8,qg),[[qe,i[d[0]],void 0,{number:!0}]])])),64))])],2)]),o("div",zg,[o("div",{class:w([n.value,"relative border-t-4 border-t-cyan-500/50 shadow-cyan-500/5"])},[u[8]||(u[8]=o("p",{class:"text-[10px] font-black uppercase tracking-widest text-cyan-400 mb-6 border-b border-cyan-500/10 pb-2"},"Crafting Configuration",-1)),o("div",$g,[o("div",Zg,[u[5]||(u[5]=o("label",{class:"block text-[9px] font-black text-slate-500 uppercase mb-1.5 group-hover:text-cyan-400 transition-colors"},"Equipment Type",-1)),o("div",Xg,[ve(o("select",{"onUpdate:modelValue":u[0]||(u[0]=d=>i.craftType=d),onChange:l,class:"w-full bg-slate-500/10 border dark:border-white/10 border-slate-200 rounded-xl p-4 font-black dark:text-cyan-100 text-slate-900 outline-none cursor-pointer appearance-none transition-all focus:ring-4 focus:ring-cyan-500/10 focus:border-cyan-500 custom-select"},[(C(),E($,null,ce(a,d=>o("option",{key:d,value:d,class:"dropdown-item"},N(d),9,em)),64))],544),[[it,i.craftType]]),u[4]||(u[4]=o("div",{class:"absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none text-cyan-500 group-hover:scale-125 transition-transform z-20"},[o("svg",{xmlns:"http://www.w3.org/2000/svg",class:"h-5 w-5",viewBox:"0 0 20 20",fill:"currentColor"},[o("path",{"fill-rule":"evenodd",d:"M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z","clip-rule":"evenodd"})])],-1))])]),o("div",tm,[o("div",nm,[u[6]||(u[6]=o("label",{class:"block text-[9px] font-black text-slate-500 uppercase mb-1.5 group-hover:text-cyan-400"},"Proficiency",-1)),ve(o("input",{type:"number","onUpdate:modelValue":u[1]||(u[1]=d=>i.prof=d),class:"w-full bg-slate-500/5 border dark:border-white/10 border-slate-200 rounded-xl p-3 text-center font-black dark:text-white outline-none focus:border-cyan-500 transition-all"},null,512),[[qe,i.prof,void 0,{number:!0}]])]),o("div",am,[u[7]||(u[7]=o("label",{class:"block text-[9px] font-black text-slate-500 uppercase mb-1.5 group-hover:text-cyan-400"},"Player Lv",-1)),ve(o("input",{type:"number","onUpdate:modelValue":u[2]||(u[2]=d=>i.level=d),class:"w-full bg-slate-500/5 border dark:border-white/10 border-slate-200 rounded-xl p-3 text-center font-black dark:text-white outline-none focus:border-cyan-500 transition-all"},null,512),[[qe,i.level,void 0,{number:!0}]])])]),o("div",im,[(C(),E($,null,ce([["createSkill","Create Equipment"],["careful","Careful Creation"],["expert","Expert's Creation"]],d=>o("div",{key:d[0],class:"flex justify-between items-center bg-gradient-to-r from-slate-500/5 to-transparent p-4 rounded-2xl border border-transparent hover:border-cyan-500/30 hover:from-cyan-500/10 transition-all group"},[o("span",lm,N(d[1]),1),ve(o("input",{type:"number","onUpdate:modelValue":m=>i[d[0]]=m,class:"w-10 bg-transparent text-right font-black text-cyan-400 outline-none group-hover:scale-125 transition-transform"},null,8,om),[[qe,i[d[0]],void 0,{number:!0}]])])),64))])])],2)]),o("div",sm,[o("div",{class:w([n.value,"relative overflow-hidden group shadow-2xl"])},[u[10]||(u[10]=o("div",{class:"absolute -right-10 -top-10 w-32 h-32 bg-orange-500/10 blur-[50px]"},null,-1)),u[11]||(u[11]=o("p",{class:"text-[10px] font-black text-orange-500 uppercase tracking-[0.3em] mb-4"},"Success Rate",-1)),o("div",rm,[o("span",{class:w(["text-8xl font-black italic tracking-tighter leading-none transition-all duration-700 hover:tracking-normal block",r.value>=100?"text-transparent bg-clip-text bg-gradient-to-br from-emerald-300 to-emerald-600 drop-shadow-[0_0_20px_rgba(52,211,153,0.5)]":"dark:text-white text-slate-900"])},N(r.value),3),u[9]||(u[9]=o("span",{class:"text-3xl font-black text-orange-500"},"%",-1))]),o("div",cm,[o("div",{class:"h-full bg-gradient-to-r from-orange-600 via-yellow-400 to-emerald-400 transition-all duration-1000 ease-out rounded-full shadow-[0_0_15px_rgba(249,115,22,0.4)]",style:_t({width:r.value+"%"})},null,4)])],2),o("div",{class:w([n.value,"border-l-4 border-l-cyan-500 relative overflow-hidden"])},[u[13]||(u[13]=o("div",{class:"absolute -left-10 -bottom-10 w-32 h-32 bg-cyan-500/10 blur-[50px]"},null,-1)),u[14]||(u[14]=o("p",{class:"text-[10px] font-black text-cyan-400 uppercase tracking-[0.3em] mb-4"},"Total Potential",-1)),o("div",um,[o("span",dm,N(c.value),1),u[12]||(u[12]=o("span",{class:"text-2xl font-black text-cyan-500/50 uppercase text-[12px]"},"Pts",-1))])],2),o("div",{class:w(n.value)},[o("div",pm,[o("div",gm,[o("span",null,"Diff Status: "+N(s.value)+" / "+N(i.itemDiff),1)]),s.value<i.itemDiff?(C(),E("div",mm,[...u[15]||(u[15]=[o("svg",{xmlns:"http://www.w3.org/2000/svg",class:"h-8 w-8",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},[o("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"})],-1),o("span",{class:"text-[10px] font-black uppercase tracking-widest"},"Low Difficulty",-1)])])):(C(),E("div",fm,[...u[16]||(u[16]=[o("svg",{xmlns:"http://www.w3.org/2000/svg",class:"h-8 w-8",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},[o("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"3",d:"M5 13l4 4L19 7"})],-1),o("span",{class:"text-[10px] font-black uppercase tracking-widest group-hover:scale-110 transition-transform"},"Ready to Craft",-1)])]))])],2)])])]))}},Am=Wt(hm,[["__scopeId","data-v-676556a4"]]),bm={class:"fixed inset-0 pointer-events-none z-0"},km={key:0,class:"absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-blue-600/10 blur-[120px] rounded-full animate-pulse"},vm={key:1,class:"absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-purple-600/10 blur-[120px] rounded-full animate-pulse"},ym={key:0,class:"relative z-10 max-w-5xl mx-auto p-6 md:p-20 animate-fade-in"},xm={class:"grid lg:grid-cols-12 gap-12 items-start"},wm={class:"lg:col-span-5 space-y-2 animate-slide-right"},_m=["src"],Pm={class:"lg:col-span-7 space-y-8 animate-slide-left"},Mm={class:"flex items-center gap-4"},Dm={class:"text-[10px] font-black text-cyan-500 uppercase tracking-[0.5em]"},Rm={class:"space-y-5"},Cm={key:0,class:"mt-2.5 w-2 h-2 rounded-full bg-cyan-500 shadow-[0_0_8px_rgba(6,182,212,1)] group-hover/stat:scale-150 transition-transform flex-shrink-0"},Sm={class:"grid grid-cols-1 md:grid-cols-2 gap-6"},Em={class:"text-sm font-bold flex items-center gap-2"},Im={class:"text-sm font-bold flex items-center gap-2 justify-between"},Bm={key:1,class:"h-screen flex items-center justify-center"},Tm={__name:"XtallDetail",props:["id","isDark"],setup(e){const t=e,n=Jn(),a=te(()=>Ut.find(y=>String(y.code)===String(t.id))),i=y=>{if(!y)return"NORMAL";let h=y,R=0;for(;h.link&&R<10;){const T=Ut.find(_=>String(_.code)===String(h.link));if(T)h=T,R++;else break}return h.type?.toUpperCase()},l=y=>{const h=i(a.value);return y?.toUpperCase()==="UPGRADE"||y?.toUpperCase()==="ENHANCER"?"text-gray-400":{WEAPON:"text-red-500",ARMOR:"text-green-500",NORMAL:"text-sky-500",ADDITIONAL:"text-yellow-500",SPECIAL:"text-purple-500"}[h]||"text-cyan-500"},s=y=>{const h=i(a.value);return{NORMAL:"bg-blue-600",WEAPON:"bg-red-600",ARMOR:"bg-green-600",ADDITIONAL:"bg-yellow-600",SPECIAL:"bg-cyan-600"}[h]||"bg-cyan-600"},r=y=>{const h=y?.toUpperCase();return h==="UPGRADE"||h==="ENHANCER"?"bg-purple-600 text-white border-purple-400":({NORMAL:"bg-blue-600",ADDITIONAL:"bg-yellow-600",WEAPON:"bg-red-600",ARMOR:"bg-green-600",SPECIAL:"bg-cyan-600"}[h]||"bg-slate-700")+" text-white border-white/20"},c=y=>{const h=y?.toUpperCase();return h==="UPGRADE"||h==="ENHANCER"?`${i(a.value)} ENHANCER`:h},p=te(()=>a.value?.link?Ut.find(y=>String(y.code)===String(a.value.link)):null),u=te(()=>a.value?Ut.find(y=>String(y.link)===String(a.value.code)):null),d=y=>{n.push(`/xtall/${y}`)};Pt(()=>t.id,()=>{window.scrollTo({top:0,behavior:"smooth"})});const m=y=>y?Array.isArray(y)?y:y.split(/,|\n/).map(h=>h.trim()).filter(h=>h):[],A=y=>{const h=y?.toUpperCase(),R=i(a.value);return h==="UPGRADE"||h==="ENHANCER"?{NORMAL:Fn,WEAPON:Ti,ARMOR:Ki,ADDITIONAL:Ni,SPECIAL:Gi}[R]||Fn:{NORMAL:Ln,WEAPON:Si,ARMOR:Ii,ADDITIONAL:Ei,SPECIAL:Bi}[R]||Ln};return(y,h)=>(C(),E("div",{class:w(["min-h-screen relative overflow-hidden font-sans transition-all duration-700",e.isDark?"bg-[#020617] text-slate-200":"bg-slate-50 text-slate-900"])},[o("div",bm,[o("div",{class:w(["absolute inset-0 bg-[url('/images/logo.png')] bg-center bg-no-repeat bg-[length:60%_auto] opacity-[0.03]",e.isDark?"brightness-200":"invert opacity-[0.02]"])},null,2),e.isDark?(C(),E("div",km)):Ce("",!0),e.isDark?(C(),E("div",vm)):Ce("",!0)]),a.value?(C(),E("div",ym,[o("button",{onClick:h[0]||(h[0]=R=>y.$router.push("/xtall")),class:"group flex items-center gap-3 mb-10 transition-all hover:-translate-x-2"},[...h[3]||(h[3]=[o("div",{class:"w-10 h-10 rounded-full border-2 border-cyan-500/50 flex items-center justify-center group-hover:bg-cyan-500 transition-all shadow-[0_0_15px_rgba(6,182,212,0.3)]"},[o("svg",{class:"w-5 h-5 text-cyan-500 group-hover:text-white",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[o("path",{d:"M15 19l-7-7 7-7","stroke-width":"3"})])],-1),o("span",{class:"text-[10px] font-black uppercase tracking-[0.3em] opacity-60 group-hover:opacity-100 group-hover:text-cyan-500"},"Back to Database",-1)])]),o("div",xm,[o("div",wm,[o("div",{class:w(["relative aspect-square rounded-[3.5rem] border-4 flex items-center justify-center overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.4)] transition-all duration-700 group",e.isDark?"bg-slate-900 border-white/20":"bg-white border-slate-300"])},[o("div",{class:w(["absolute inset-0 opacity-30 blur-3xl animate-pulse transition-colors duration-700",s(a.value.type)])},null,2),o("img",{src:A(a.value.type),class:"relative w-48 h-48 md:w-64 md:h-64 object-contain drop-shadow-[0_10px_20px_rgba(0,0,0,0.5)] transition-transform duration-700 group-hover:scale-110 animate-float"},null,8,_m),o("div",{class:w(["absolute bottom-8 px-6 py-2 rounded-2xl border-2 font-black text-[10px] tracking-widest uppercase shadow-2xl whitespace-nowrap transition-all duration-500 group-hover:scale-110",r(a.value.type)])},N(c(a.value.type)),3)],2)]),o("div",Pm,[o("div",null,[o("p",{class:w(["text-xs font-black uppercase tracking-[0.4em] mb-2 drop-shadow-sm",l(a.value.name)])},N(c(a.value.type)),3),o("h1",{class:w(["text-5xl md:text-7xl font-[1000] tracking-tighter italic uppercase leading-none mb-4 drop-shadow-2xl transition-all duration-500 brightness-100 saturate-70",l(a.value.type),e.isDark?"[-webkit-text-stroke:1px_white]":"[-webkit-text-stroke:1px_black]"]),style:{maskImage:"linear-gradient(to bottom, black 10%, rgba(0,0,0,0.5) 100%)",webkitMaskImage:"linear-gradient(to bottom, black 10%, rgba(0,0,0,0.5) 100%)"}},N(a.value.name),3),o("div",Mm,[h[4]||(h[4]=o("div",{class:"h-[3px] w-16 bg-cyan-500 shadow-[0_0_10px_rgba(6,182,212,0.8)]"},null,-1)),o("p",Dm,"System ID: #"+N(a.value.code),1)])]),o("div",{class:w(["p-8 md:p-12 rounded-[3rem] border-2 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)] backdrop-blur-3xl relative overflow-hidden transition-all hover:border-cyan-500/50",e.isDark?"bg-slate-900/80 border-white/10 shadow-black":"bg-white border-slate-200 shadow-slate-300"])},[h[5]||(h[5]=o("div",{class:"absolute top-0 right-0 p-8 text-8xl opacity-[0.05] grayscale pointer-events-none animate-spin-slow"},"✨",-1)),h[6]||(h[6]=o("h3",{class:"text-xs font-black uppercase tracking-[0.5em] text-slate-500 mb-8 flex items-center gap-3"},[o("span",{class:"w-2 h-2 bg-cyan-500 rounded-full animate-ping"}),Ve(" Status/ Effect ")],-1)),o("div",Rm,[(C(!0),E($,null,ce(m(a.value.view),(R,T)=>(C(),E("div",{key:T,class:"flex items-start gap-4 group/stat animate-fade-in",style:_t({animationDelay:T*100+"ms"})},[R.includes("Dengan")?Ce("",!0):(C(),E("div",Cm)),o("p",{class:w(["text-base md:text-lg font-bold tracking-tight transition-colors",R.includes("Dengan")?"text-green-500 italic":R.includes("-")?"text-red-500":e.isDark?"text-slate-200 group-hover/stat:text-cyan-400":"text-slate-700"])},N(R),3)],4))),128))])],2),o("div",Sm,[p.value?(C(),E("div",{key:0,onClick:h[1]||(h[1]=R=>d(p.value.code)),class:w(["group p-6 rounded-[2.5rem] border-2 cursor-pointer transition-all duration-500 hover:-translate-y-2 shadow-xl",e.isDark?"bg-slate-900 border-white/5 hover:border-cyan-500/50 hover:shadow-cyan-900/20":"bg-white border-slate-200 hover:border-cyan-500 shadow-slate-200"])},[h[8]||(h[8]=o("p",{class:"text-[9px] font-black text-slate-500 uppercase tracking-widest mb-2"},"Previous Model",-1)),o("p",Em,[h[7]||(h[7]=o("span",{class:"text-cyan-500 group-hover:-translate-x-2 transition-transform"},"←",-1)),Ve(" "+N(p.value.name),1)])],2)):Ce("",!0),u.value?(C(),E("div",{key:1,onClick:h[2]||(h[2]=R=>d(u.value.code)),class:w(["group p-6 rounded-[2.5rem] border-2 cursor-pointer transition-all duration-500 hover:-translate-y-2 shadow-xl",e.isDark?"bg-slate-900 border-white/5 hover:border-purple-500/50 hover:shadow-purple-900/20":"bg-white border-slate-200 hover:border-purple-500 shadow-slate-200"])},[h[10]||(h[10]=o("p",{class:"text-[9px] font-black text-slate-500 uppercase tracking-widest mb-2"},"Advanced Upgrade",-1)),o("p",Im,[Ve(N(u.value.name)+" ",1),h[9]||(h[9]=o("span",{class:"text-purple-500 group-hover:translate-x-2 transition-transform"},"→",-1))])],2)):Ce("",!0)])])])])):(C(),E("div",Bm,[...h[11]||(h[11]=[o("div",{class:"relative w-24 h-24"},[o("div",{class:"absolute inset-0 border-4 border-cyan-500/20 rounded-full"}),o("div",{class:"absolute inset-0 border-4 border-t-cyan-500 rounded-full animate-spin"})],-1)])]))],2))}},Km=Wt(Tm,[["__scopeId","data-v-d58076e3"]]),Nm={"Base Stats":[{label:"STR / STR%",value:"STR"},{label:"INT / INT%",value:"INT"},{label:"DEX / DEX%",value:"DEX"},{label:"AGI / AGI%",value:"AGI"},{label:"VIT / VIT%",value:"VIT"}],"ATK & DEF":[{label:"ATK / ATK%",value:".ATK"},{label:"MATK / MATK%",value:"MATK"},{label:"DEF / DEF%",value:".DEF"},{label:"MDEF / MDEF%",value:"MDEF"}],"Stability, Accuracy, Dodge":[{label:"Stability",value:"Stability"},{label:"Akurasi",value:"Akurasi"},{label:"Dodge",value:"Dodge"}],Critical:[{label:"Critical Rate / CR%",value:"Critical Rate"},{label:"Critical Damage / CD%",value:"Critical Damage"}],Speed:[{label:"ASPD / ASPD%",value:"ASPD"},{label:"CSPD / CSPD%",value:"CSPD"},{label:"Motion Speed%",value:"Motion Speed"}],"HP & MP":[{label:"MaxHP / MaxHP%",value:"MaxHP"},{label:"MaxMP / MaxMP%",value:"MaxMP"},{label:"Natural MP Regen%",value:"Natural MP Regen"},{label:"Natural HP Regen%",value:"Natural HP Regen"},{label:"Attack MP Recovery / AMPR%",value:"Attack MP Recovery"}],"Weapon ATK & Element":[{label:"Weapon ATK%",value:"Weapon ATK"},{label:"DTE (Elements)%",value:"stronger against"}],"Element Resistance":[{label:"Phys Resistance%",value:"Kekebalan Fisik"},{label:"Magic Resistance%",value:"Kekebalan Sihir"},{label:"Light Resistance%",value:"kebal Cahaya"},{label:"Dark Resistance%",value:"kebal Gelap"},{label:"Earth Resistance%",value:"kebal Bumi"},{label:"Fire Resistance%",value:"kebal Api"},{label:"Water Resistance%",value:"kebal Air"},{label:"Wind Resistance%",value:"kebal Angin"}],"Barrier & Defense Effect":[{label:"Fractional Barrier%",value:"Pelindung Fraksional"},{label:"Ailment Resistance%",value:"Resistansi Status Buruk"},{label:"Aggro%",value:"Aggro"}],"Offensive Effect":[{label:"Physical Pierce%",value:"Physical Pierce"},{label:"Magic Pierce%",value:"Peneterasi Sihir"},{label:"Short Range Dmg%",value:"Daya Jarak Dekat"},{label:"Long Range Dmg%",value:"Daya Jarak Jauh"},{label:"Unsheathe Attack%",value:"Serangan Menghunus"},{label:"Additional Melee%",value:"Tambahan Fisik"},{label:"Additional Magic%",value:"Tambahan Sihir"},{label:"Antisipasi%",value:"Antisipasi"},{label:"Guard Break%",value:"Guard Break"}],"Reduce DMG":[{label:"Reduksi DMG (Sekitar Pemain)%",value:"Reduksi DMG (Sekitar Pemain)"},{label:"Reduksi DMG (Sekitar Musuh)%",value:"Reduksi DMG (Sekitar Musuh)"},{label:"Reduksi DMG (Lantai)%",value:"Reduksi DMG (Lantai)"},{label:"Reduksi DMG (Linear)%",value:"Reduksi DMG (Linear)"},{label:"Reduksi DMG (Bowling)%",value:"Reduksi DMG (Bowling)"},{label:"Reduksi DMG (Terjang)%",value:"Reduksi DMG (Terjang)"},{label:"Reduksi DMG (Peluru)%",value:"Reduksi DMG (Peluru)"}],"Other Stat":[{label:"Drop Rate%",value:"Drop Rate"},{label:"EXP%",value:"EXP"},{label:"Revive Time%",value:"Revive Time"},{label:"Tumble Unavailable%",value:"Tumble Unavailable"},{label:"Evasion Recharge%",value:"Evasion Recharge"},{label:"Refleks%",value:"Refleks"},{label:"Recoil%",value:"Recoil"}]},Yl={"Base Stats":{text:"text-orange-400",border:"border-orange-500/30",accent:"text-orange-500 focus:ring-orange-500"},"ATK & DEF":{text:"text-cyan-400",border:"border-cyan-500/30",accent:"text-cyan-500 focus:ring-cyan-500"},"Stability, Accuracy, Dodge":{text:"text-blue-400",border:"border-blue-500/30",accent:"text-blue-500 focus:ring-blue-500"},Critical:{text:"text-red-400",border:"border-red-500/30",accent:"text-red-500 focus:ring-red-500"},Speed:{text:"text-pink-400",border:"border-pink-500/30",accent:"text-pink-500 focus:ring-pink-500"},"HP & MP":{text:"text-emerald-400",border:"border-emerald-500/30",accent:"text-emerald-500 focus:ring-emerald-500"},"Weapon ATK & Element":{text:"text-yellow-400",border:"border-yellow-500/30",accent:"text-yellow-500 focus:ring-yellow-500"},"Element Resistance":{text:"text-amber-500",border:"border-amber-500/30",accent:"text-amber-500 focus:ring-amber-500"},"Barrier & Defense Effect":{text:"text-green-500",border:"border-green-500/30",accent:"text-green-500 focus:ring-green-500"},"Offensive Effect":{text:"text-indigo-400",border:"border-indigo-500/30",accent:"text-indigo-500 focus:ring-indigo-500"},"Reduce DMG":{text:"text-teal-400",border:"border-teal-500/30",accent:"text-teal-500 focus:ring-teal-500"},"Other Stat":{text:"text-purple-400",border:"border-purple-500/30",accent:"text-purple-500 focus:ring-purple-500"}},Gm=[{label:"Weapon Crystas",value:"WEAPON",icon:Si,color:"red"},{label:"Weapon Enhancer Crystas",value:"WEAPON_UPGRADE",icon:Ti,color:"red"},{label:"Armor Crystas",value:"ARMOR",icon:Ii,color:"green"},{label:"Armor Enhancer Crystas",value:"ARMOR_UPGRADE",icon:Ki,color:"green"},{label:"Additional Crystas",value:"ADDITIONAL",icon:Ei,color:"yellow"},{label:"Additional Enhancer Crystas",value:"ADDITIONAL_UPGRADE",icon:Ni,color:"yellow"},{label:"Normal Crystas",value:"NORMAL",icon:Ln,color:"blue"},{label:"Normal Enhancer Crystas",value:"NORMAL_UPGRADE",icon:Fn,color:"blue"},{label:"Special Crystas",value:"SPECIAL",icon:Bi,color:"pink"},{label:"Special Enhancer Crystas",value:"SPECIAL_UPGRADE",icon:Gi,color:"pink"}],Om={class:"max-w-[1600px] mx-auto mb-6 flex items-center justify-between"},Lm={class:"max-w-[1600px] mx-auto mb-12 flex flex-col lg:flex-row lg:items-end justify-between gap-8"},Fm={class:"text-5xl md:text-7xl font-[1000] tracking-tighter uppercase italic leading-[0.8]"},Um={class:"text-2xl md:text-2xl font-[100] tracking-tighter uppercase italic leading-[0.8]"},Hm={class:"max-w-[1600px] mx-auto space-y-5"},jm={class:"grid grid-cols-4 md:grid-cols-6 lg:grid-cols-8 xl:grid-cols-10 gap-4"},Wm=["onClick"],Jm=["src","alt"],Vm={key:0,class:"absolute top-4 right-6 w-2 h-2 bg-white rounded-full animate-pulse shadow-[0_0_10px_white]"},Ym={class:"flex items-center gap-1 mb-4 ml-2"},Qm={class:"grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-7 gap-2"},qm=["onClick"],zm={class:"flex items-start justify-between gap-2 mb-4"},$m={key:0,class:"w-4 h-4 text-white",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},Zm={class:"flex gap-1"},Xm=["onUpdate:modelValue"],ef=["onUpdate:modelValue"],tf=["onUpdate:modelValue"],nf={__name:"XtallAdvancedSearch",props:{isDark:Boolean},setup(e){const t=Jn(),n=Ra(),a=hn({stats:{},types:[]});tn(()=>{if(n.query.filter)try{const p=JSON.parse(n.query.filter);p?.stats&&(a.stats=p.stats),p?.types&&(a.types=p.types)}catch{console.warn("Invalid filter data")}});function i(){t.back()}function l(){Object.keys(a.stats).forEach(p=>delete a.stats[p]),a.types=[]}function s(p){a.stats[p]?delete a.stats[p]:a.stats[p]={sign:"+",op:">=",value:null}}function r(p){const u=a.types.indexOf(p);u>-1?a.types.splice(u,1):a.types.push(p)}function c(){t.push({name:"xtall",query:{filter:JSON.stringify(a)}})}return(p,u)=>(C(),E("div",{class:w(["p-4 md:p-8 font-sans transition-all duration-700 min-h-screen",e.isDark?"bg-[#050505] text-white":"bg-slate-50 text-slate-900"])},[o("div",Om,[o("button",{onClick:i,class:"group flex items-center gap-3 px-4 py-2 rounded-xl transition-all hover:bg-white/5 active:scale-95"},[o("div",{class:w(["w-10 h-10 rounded-full flex items-center justify-center border-2 transition-all",e.isDark?"border-white/10 group-hover:border-orange-500/50 group-hover:bg-orange-500/10":"border-slate-200 group-hover:border-orange-500/50 group-hover:bg-orange-50"])},[...u[1]||(u[1]=[o("svg",{xmlns:"http://www.w3.org/2000/svg",class:"w-5 h-5 transition-transform group-hover:-translate-x-1",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},[o("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"3",d:"M15 19l-7-7 7-7"})],-1)])],2),u[2]||(u[2]=o("span",{class:"text-[11px] font-[1000] uppercase tracking-[0.2em] opacity-80 group-hover:opacity-100"},"Back",-1))])]),o("div",Lm,[o("div",null,[o("h1",Fm,[o("span",{class:w(e.isDark?"text-white":"text-black")},"Advanced",2),u[3]||(u[3]=o("br",null,null,-1)),u[4]||(u[4]=o("span",{class:"bg-gradient-to-r from-orange-500 via-red-500 to-yellow-500 bg-clip-text text-transparent animate-gradient-x"},"Search",-1))]),o("h2",Um,[u[5]||(u[5]=o("br",null,null,-1)),o("span",{class:w(e.isDark?"text-white":"text-black")},"All Flat and percent(%) stats are combined ",2),u[6]||(u[6]=o("br",null,null,-1))])]),o("div",{class:"flex flex-row items-center gap-4 w-full lg:w-auto"},[o("button",{onClick:l,class:"flex-1 lg:flex-none px-8 py-5 rounded-2xl font-black uppercase tracking-widest text-[10px] bg-red-500/10 text-red-500 border-2 border-red-500/20 hover:bg-red-500 hover:text-white transition-all duration-300"}," Clear Page "),o("button",{onClick:c,class:"flex-[2] lg:flex-none px-10 py-5 bg-orange-600 rounded-2xl transition-all duration-500 hover:scale-105 active:scale-95 shadow-[0_15px_40px_rgba(234,88,12,0.3)]"},[...u[7]||(u[7]=[o("span",{class:"text-xs font-[1000] uppercase tracking-[0.2em] text-white"},"Apply Parameters",-1)])])])]),o("div",Hm,[o("section",null,[u[8]||(u[8]=o("div",{class:"flex items-center gap-3 mb-8 ml-2"},[o("div",{class:"w-1.5 h-6 rounded-full bg-cyan-500"}),o("h2",{class:"text-lg font-[1000] uppercase tracking-[0.3em] italic text-cyan-500"},"Type Crysta")],-1)),o("div",jm,[(C(!0),E($,null,ce(Ge(Gm),d=>(C(),E("div",{key:d.value,onClick:m=>r(d.value),class:w(["group relative p-5 rounded-[2.5rem] border-2 cursor-pointer transition-all duration-500 flex flex-col items-center gap-4 min-h-[160px] justify-center",a.types.includes(d.value)?"bg-[#468FE0] border-cyan-400 shadow-xl shadow-cyan-600/80 scale-[1.12]":e.isDark?"bg-[#0a0a0a] border-white/5 hover:border-white/20":"bg-white border-slate-100 shadow-sm hover:border-slate-300"])},[o("div",{class:w(["w-16 h-16 rounded-full overflow-hidden border-2 transition-all duration-500 group-hover:rotate-6 group-hover:scale-110 shadow-inner",a.types.includes(d.value)?"border-white shadow-lg":"border-slate-800/50"])},[o("img",{src:d.icon,class:"w-full h-full object-cover",alt:d.label},null,8,Jm)],2),o("span",{class:w(["text-[10px] font-black uppercase tracking-[0.15em] text-center leading-tight transition-colors",a.types.includes(d.value)?"text-white":e.isDark?"text-slate-400":"text-slate-500"])},N(d.label),3),a.types.includes(d.value)?(C(),E("div",Vm)):Ce("",!0)],10,Wm))),128))])]),(C(!0),E($,null,ce(Ge(Nm),(d,m)=>(C(),E("div",{key:m},[o("div",Ym,[o("div",{class:w(["w-1.5 h-6 rounded-full",Ge(Yl)[m]?.bg||"bg-slate-500"])},null,2),o("h2",{class:w(["text-lg font-[1000] uppercase tracking-[0.3em] italic",Ge(Yl)[m]?.text||"text-slate-500"])},N(m),3)]),o("div",Qm,[(C(!0),E($,null,ce(d,A=>(C(),E("div",{key:A.value,onClick:y=>s(A.value),class:w(["group/item relative rounded-[2rem] border-2 p-2 cursor-pointer transition-all duration-500 flex flex-col justify-between min-h-[70px]",a.stats[A.value]?e.isDark?"bg-orange-600/20 border-orange-500 shadow-lg shadow-orange-500/20":"bg-orange-50 border-orange-500":e.isDark?"bg-[#0a0a0a] border-white/5 hover:border-white/20":"bg-white border-slate-100 hover:border-slate-300 shadow-sm"])},[o("div",zm,[o("span",{class:w(["text-[11px] font-[1000] uppercase leading-tight tracking-wide transition-colors",a.stats[A.value]?e.isDark?"text-white":"text-orange-600":e.isDark?"text-slate-500":"text-slate-400"])},N(A.label),3),o("div",{class:w(["shrink-0 w-8 h-8 rounded-xl border flex items-center justify-center transition-all duration-500",a.stats[A.value]?"bg-orange-500 border-orange-400 rotate-0":e.isDark?"bg-white/5 border-white/10 rotate-45":"bg-slate-50 border-slate-200 rotate-45"])},[a.stats[A.value]?(C(),E("svg",$m,[...u[9]||(u[9]=[o("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"4",d:"M5 13l4 4L19 7"},null,-1)])])):(C(),E("div",{key:1,class:w(["text-lg leading-none",e.isDark?"text-white/20":"text-slate-300"])},"+",2))],2)]),ye(us,{name:"fade"},{default:Xe(()=>[a.stats[A.value]?(C(),E("div",{key:0,onClick:u[0]||(u[0]=Vc(()=>{},["stop"])),class:"space-y-2 mt-auto pt-4 border-t border-orange-500/20"},[o("div",Zm,[ve(o("select",{"onUpdate:modelValue":y=>a.stats[A.value].sign=y,class:w(["flex-1 py-2.5 rounded-xl text-center font-black text-[10px] outline-none border transition-colors",e.isDark?"bg-black border-white/10 text-orange-400":"bg-white border-slate-200 text-orange-600"])},[...u[10]||(u[10]=[o("option",{value:"+"},"Stats +",-1),o("option",{value:"-"},"Stats -",-1)])],10,Xm),[[it,a.stats[A.value].sign]]),ve(o("select",{"onUpdate:modelValue":y=>a.stats[A.value].op=y,class:w(["flex-1 py-2.5 rounded-xl text-center font-black text-[10px] outline-none border transition-colors",e.isDark?"bg-black border-white/10 text-cyan-400":"bg-white border-slate-200 text-cyan-600"])},[...u[11]||(u[11]=[o("option",{value:">="},"≥",-1),o("option",{value:"<="},"≤",-1)])],10,ef),[[it,a.stats[A.value].op]])]),ve(o("input",{type:"number","onUpdate:modelValue":y=>a.stats[A.value].value=y,class:w(["w-full py-2.5 rounded-xl text-center font-black text-[10px] outline-none border transition-all focus:border-orange-500",e.isDark?"bg-black border-white/10 text-white":"bg-white border-slate-200 text-black"]),placeholder:"VALUE"},null,10,tf),[[qe,a.stats[A.value].value,void 0,{number:!0}]])])):Ce("",!0)]),_:2},1024)],10,qm))),128))])]))),128))])],2))}},af=Wt(nf,[["__scopeId","data-v-1f142105"]]),lf=[{path:"/",name:"bag",component:p0},{path:"/mq",name:"mainquest",component:V0},{path:"/mq-calc",name:"mqcalc",component:Ig},{path:"/bs-calc",name:"bs-calc",component:Am},{path:"/xtall",name:"xtall",component:Hp},{path:"/xtall/advanced",name:"xtall-advanced",component:af},{path:"/xtall/:id(\\d+)",name:"xtall-detail",component:Km,props:!0}],of=id({history:Nu("/toram-vue/"),routes:lf});document.title||(document.title="Timi DB | Toram Online Database");const _s=qc(bd);_s.use(of);_s.mount("#app");window.addEventListener("unhandledrejection",e=>{console.warn("Ignored async listener error:",e.reason)});
