...
Kekebalan Fisik +10%
Kekebalan Sihir +10%
Kecepatan Item -1.0s`}],Ii="/toram-vue/assets/enhance_weapon_crysta-eGLehiWn.png",Bi="/toram-vue/assets/enhance_armor_crysta-YvncoZmF.png",Ni="/toram-vue/assets/enhance_additional_crysta-mE1Kazx1.png",Oi="/toram-vue/assets/enhace_special_crysta-CIVkxwj2.png";function Vd(e){const t={};return e&&e.split(`
`).map(n=>n.trim()).forEach(n=>{if(!n.match(/[+-]\s*\d/))return;const a=n.match(/^(.+?)\s*([+-])\s*(\d+)(%)?$/);if(!a)return;const[,i,l,o]=a;t[i.trim().toUpperCase()]={sign:l,value:Number(o)}}),t}const Jd={class:"fixed inset-0 pointer-events-none z-0"},Wd={key:0,class:"absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-blue-600/10 blur-[120px] rounded-full animate-pulse"},Qd={key:1,class:"absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-purple-600/10 blur-[120px] rounded-full animate-pulse",style:{"animation-delay":"2s"}},qd={class:"relative z-10 max-w-[1700px] mx-auto p-4 md:p-10 space-y-8 md:space-y-14"},zd={class:"flex items-center gap-6"},$d={class:"text-center md:text-left space-y-1"},Xd={class:"flex items-center gap-3"},Zd={class:"text-4xl md:text-6xl font-[1000] italic uppercase tracking-tighter leading-none transition-all"},Yd={class:"flex flex-col items-center md:items-end gap-3"},ep={class:"flex gap-2"},tp={class:"space-y-2 col-span-2 md:col-span-2 lg:col-span-2"},np={class:"relative group"},ap={class:"space-y-2 col-span-1"},ip={class:"relative group"},lp={class:"space-y-0 w-full col-span-2 lg:col-span-3"},sp={class:"flex flex-col md:flex-row items-center gap-3 w-full"},op={class:"relative group w-full"},rp={class:"relative py-4 flex items-center justify-center"},cp={class:"space-y-10 relative z-10 pb-32"},up={class:"lg:col-span-3 flex flex-row lg:flex-col gap-3 overflow-x-auto lg:overflow-visible pb-2 scroll-hide"},dp=["onClick"],pp={key:1,class:"hidden lg:flex flex-1 items-center justify-center opacity-10"},fp={class:"lg:col-span-6 relative group"},mp={class:"relative p-6 md:p-10"},gp={class:"flex flex-col md:flex-row gap-8 items-start"},hp={class:"relative shrink-0 mx-auto md:mx-0"},bp=["src","alt"],Ap={class:"flex-1 space-y-6 w-full"},kp={class:"space-y-2"},vp={class:"grid grid-cols-1 gap-4"},xp={key:0,class:"w-2 h-2 rounded-full bg-gradient-to-r from-green-500 to-cyan-400 group-hover/item:scale-150 transition-transform flex-shrink-0"},yp={class:"flex items-center gap-4"},wp={class:"flex flex-col"},Pp={class:"lg:col-span-3 flex flex-row lg:flex-col gap-3 overflow-x-auto lg:overflow-visible pb-2 scroll-hide"},Mp=["onClick"],Dp={key:1,class:"hidden lg:flex flex-1 items-center justify-center opacity-10"},Rp={key:0,class:"py-40 text-center animate-pulse"},Sp={class:"flex flex-col items-center gap-10 py-20"},Cp={key:0,class:"flex flex-wrap justify-center items-center gap-3"},Ep=["disabled"],Tp={class:"flex gap-2.5 items-center"},_p=["onClick"],Kp={key:1,class:"px-2 font-black text-blue-500"},Ip=["disabled"],Bp={class:"flex items-center gap-4 opacity-50"},Np={class:"text-[10px] font-black text-slate-500 uppercase tracking-[0.4em]"},Op={class:"fixed bottom-8 left-8 z-[200] hidden lg:block"},Lp={__name:"XtallView",props:{isDark:{type:Boolean,default:!0}},setup(e){const t=new Map;function n(I){return t.has(I.code)||t.set(I.code,Vd(I.view)),t.get(I.code)}const a=Wn();function i(){l.value="",o.value=[],r.value=[],m.value="asc",d.value=10,a.push({query:{}})}const l=se(""),o=se([]),r=se([]),c=se(!1),p=se(!1),u=se(1),d=se(10),m=se("asc"),b=se(null),v=se(null),h=Sa(),A=te(()=>{try{return h.query.filter?JSON.parse(h.query.filter):null}catch{return null}}),y=()=>{l.value="",o.value=[],r.value=[],u.value=1},S=I=>{const x=I.type?.toUpperCase();if(x!=="UPGRADE")return ee[x]||Un;const ae=Pe(I);return ee[`${ae}_UPGRADE`]||Hn},E=I=>({NORMAL:"bg-blue-500/10 text-blue-500 border-blue-500/40",UPGRADE:"bg-purple-500/10 text-purple-500 border-purple-500/40",ADDITIONAL:"bg-yellow-500/10 text-yellow-500 border-yellow-500/40",WEAPON:"bg-red-500/10 text-red-500 border-red-500/40",ARMOR:"bg-green-500/10 text-green-500 border-green-500/40",SPECIAL:"bg-pink-500/10 text-pink-500 border-pink-500/40"})[I?.toUpperCase()]||"bg-slate-500/10 text-slate-500 border-slate-500/40",R=I=>I.link?Ht.find(x=>String(x.code)===String(I.link)):null,V=I=>Ht.filter(x=>String(x.link)===String(I.code)),ee={NORMAL:Un,UPGRADE:Hn,ADDITIONAL:Ti,ADDITIONAL_UPGRADE:Ni,ARMOR:_i,ARMOR_UPGRADE:Bi,WEAPON:Ei,WEAPON_UPGRADE:Ii,SPECIAL:Ki,SPECIAL_UPGRADE:Oi},re=I=>{if(!I)return null;let x=I,ae=0;for(;x.link&&ae<10;){const ge=Ht.find(F=>String(F.code)===String(x.link));if(!ge)break;x=ge,ae++}return x},Pe=I=>re(I)?.type?.toUpperCase()||"NORMAL",Q=I=>{if(!I)return"text-cyan-500";const x=I.type?.toUpperCase();if(x==="UPGRADE"||x==="ENHANCER")return"text-gray-400";const ae=Pe(I);return{WEAPON:"text-red-500",ARMOR:"text-green-500",NORMAL:"text-sky-500",ADDITIONAL:"text-yellow-500",SPECIAL:"text-purple-500"}[ae]||"text-cyan-500"},Y=I=>I?Array.isArray(I)?I:I.split(/,|\n/).map(x=>x.trim()).filter(x=>x):[],oe=I=>{l.value=I,window.scrollTo({top:0,behavior:"smooth"})},G=te(()=>{let I=Ht.filter(x=>x.name?.trim());if(A.value){const{stats:x,types:ae}=A.value;x&&Object.keys(x).length>0&&(I=I.filter(ge=>{const F=n(ge);return Object.entries(x).every(([we,pe])=>{const Te=F[we.toUpperCase()];return!(!Te||Te.sign!==pe.sign||pe.value!==null&&(pe.op===">="&&Te.value<pe.value||pe.op==="<="&&Te.value>pe.value))})})),ae&&ae.length>0&&(I=I.filter(ge=>{const F=Pe(ge),we=ge.type==="UPGRADE";return ae.some(pe=>{if(!pe.includes("_"))return!we&&F===pe;const[Te,ht]=pe.split("_");return ht==="UPGRADE"&&we&&F===Te})}))}if(l.value){const x=l.value.toLowerCase();I=I.filter(ae=>ae.name.toLowerCase().includes(x))}return o.value.length>0&&(I=I.filter(x=>{const ae=Pe(x),ge=x.type==="UPGRADE";return o.value.some(F=>{if(!F.includes("_"))return!ge&&ae===F;const[we,pe]=F.split("_");return pe==="UPGRADE"&&ge&&ae===we})})),r.value.length>0&&(I=I.filter(x=>{const ae=(x.view||"").toUpperCase();return r.value.every(ge=>ae.includes(ge.toUpperCase()))})),I.sort((x,ae)=>m.value==="asc"?x.name.localeCompare(ae.name):ae.name.localeCompare(x.name))}),ne=te(()=>{const I=(u.value-1)*d.value;return G.value.slice(I,I+d.value)}),Me=te(()=>Math.ceil(G.value.length/d.value)||1),Le=te(()=>{let I=Math.max(1,u.value-2),x=Math.min(Me.value,I+4);x-I<4&&(I=Math.max(1,x-4));const ae=[];for(let ge=I;ge<=x;ge++)ae.push(ge);return ae}),ye=I=>{b.value&&!b.value.contains(I.target)&&(c.value=!1),v.value&&!v.value.contains(I.target)&&(p.value=!1)};return tn(()=>{window.addEventListener("click",ye)}),wi(()=>{window.removeEventListener("click",ye)}),Mt([l,o,r,d,m],()=>{u.value=1}),(I,x)=>{const ae=oa("RouterLink"),ge=oa("router-link");return T(),K("div",{class:w(["min-h-screen relative overflow-x-hidden font-sans transition-all duration-700 bg-transparent",e.isDark?"text-slate-200":"text-slate-900"])},[s("div",Jd,[s("div",{class:w(["absolute inset-0 bg-[url('/images/logo.png')] bg-center bg-no-repeat bg-[length:60%_auto] opacity-[0.03] transition-opacity duration-1000",e.isDark?"brightness-200":"invert opacity-[0.02]"])},null,2),x[6]||(x[6]=s("div",{class:"absolute inset-0 bg-gradient-to-b from-transparent to-transparent"},null,-1)),e.isDark?(T(),K("div",Wd)):Ie("",!0),e.isDark?(T(),K("div",Qd)):Ie("",!0)]),s("div",qd,[s("header",{class:w(["relative group flex flex-col md:flex-row justify-between items-center md:items-end gap-8 pb-10 border-b-2 transition-all duration-500",e.isDark?"border-white/5":"border-black/5"])},[s("div",zd,[x[9]||(x[9]=s("div",{class:"relative group"},[s("div",{class:"absolute -inset-1 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl blur opacity-25 group-hover:opacity-75 transition duration-1000 group-hover:duration-200"}),s("img",{src:Ma,class:"relative h-16 w-auto object-contain drop-shadow-2xl transition-transform duration-500 group-hover:scale-110",alt:"Logo"})],-1)),s("div",$d,[s("div",Xd,[s("h1",Zd,[s("span",{class:w(I.text-I.white)},"TIMI ",2),x[7]||(x[7]=s("span",{class:"text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-purple-500 to-red-500"},"DB",-1))]),x[8]||(x[8]=s("div",{class:"px-2 py-0.5 bg-blue-500/10 border border-blue-500/20 rounded text-[8px] font-black text-blue-500 tracking-widest uppercase"},"Bahasa Indonesia",-1))]),s("p",{class:w(["text-xs font-black uppercase tracking-[0.5em] opacity-60",e.isDark?"text-slate-400":"text-slate-500"])},"Toram Online Database",2)])]),s("div",Yd,[s("div",{class:w(["group relative px-8 py-3 rounded-2xl border-2 overflow-hidden transition-all duration-500",e.isDark?"bg-slate-900/40 border-white/10":"bg-white border-slate-200 shadow-xl shadow-slate-200/50"])},[x[10]||(x[10]=s("div",{class:"absolute inset-0 bg-gradient-to-r from-blue-600/10 to-purple-600/10 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000"},null,-1)),s("span",{class:w(["relative text-xs font-black uppercase tracking-[0.2em]",e.isDark?"text-cyan-400":"text-blue-600"])}," Results : "+O(G.value.length)+" Xtall ",3)],2),s("div",ep,[(T(),K($,null,me(3,F=>s("div",{key:F,class:"w-8 h-1 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 opacity-20"})),64))])])],2),xe(ae,{to:"/xtall/advanced",class:"mb-6 block w-full rounded-2xl border-2 border-indigo-500 bg-gradient-to-t from-indigo-400 to-purple-500 px-6 py-5 text-center text-lg font-black text-white shadow-xl hover:scale-[1.02] transition"},{default:Ye(()=>[...x[11]||(x[11]=[Je(" 🔎 Advanced Xtall Search ",-1)])]),_:1}),s("section",{class:w(["grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 p-6 md:p-8 rounded-[3rem] border-2 backdrop-blur-3xl relative z-[100] transition-all duration-500 shadow-2xl",e.isDark?"bg-slate-950/60 border-red/100 shadow-black/40":"bg-red/80 border-slate-200 shadow-slate-300/50"])},[s("div",tp,[x[14]||(x[14]=s("label",{class:"text-[10px] font-black uppercase tracking-[0.2em] text-cyan-500 ml-4 flex items-center gap-2"},[s("span",{class:"w-1.5 h-1.5 rounded-full bg-cyan-500 animate-ping"}),Je(" Search Name ")],-1)),s("div",np,[x[12]||(x[12]=s("div",{class:"absolute -inset-0.5 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-2xl blur opacity-0 group-focus-within:opacity-20 transition-opacity duration-500"},null,-1)),ve(s("input",{"onUpdate:modelValue":x[0]||(x[0]=F=>l.value=F),type:"text",placeholder:"Search xtall name...",class:w(["relative w-full pl-12 pr-4 py-4 rounded-2xl border-2 outline-none transition-all font-bold text-sm",e.isDark?"bg-slate-900/50 border-white/5 focus:border-cyan-500 text-white placeholder-slate-600":"bg-white border-slate-200 focus:border-cyan-500 text-slate-800 placeholder-slate-400"])},null,2),[[ze,l.value]]),x[13]||(x[13]=s("svg",{class:"absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-cyan-500 transition-transform group-focus-within:scale-110",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[s("path",{d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z","stroke-width":"3"})],-1))])]),s("div",ap,[x[17]||(x[17]=s("label",{class:"text-[10px] font-black uppercase tracking-[0.2em] text-purple-500 ml-4"},"Scale",-1)),s("div",ip,[ve(s("select",{"onUpdate:modelValue":x[1]||(x[1]=F=>d.value=F),class:w(["w-full px-4 py-4 rounded-2xl border-2 outline-none font-bold text-sm appearance-none cursor-pointer transition-all pr-10",e.isDark?"bg-slate-900/50 border-white/5 focus:border-purple-500 text-slate-200":"bg-white border-slate-200 focus:border-purple-500 shadow-sm"])},[...x[15]||(x[15]=[s("option",{value:10},"10 Units",-1),s("option",{value:25},"25 Units",-1),s("option",{value:50},"50 Units",-1),s("option",{value:9999},"Show All",-1)])],2),[[it,d.value]]),x[16]||(x[16]=s("svg",{class:"absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500 pointer-events-none group-hover:rotate-180 transition-transform duration-500",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[s("path",{d:"M19 9l-7 7-7-7","stroke-width":"3"})],-1))])]),s("div",lp,[x[21]||(x[21]=s("div",{class:"flex items-center gap-2 ml-4"},[s("div",{class:"w-1.5 h-4 bg-red-600 rounded-full"}),s("label",{class:"text-[11px] font-[1000] uppercase tracking-[0.25em] text-red-600"}," Sequence & Reset Control Center ")],-1)),s("div",sp,[s("div",op,[ve(s("select",{"onUpdate:modelValue":x[2]||(x[2]=F=>m.value=F),class:w(["w-full h-[60px] px-6 rounded-2xl border-2 outline-none font-bold text-sm appearance-none cursor-pointer transition-all pr-12",e.isDark?"bg-slate-900 border-white/10 focus:border-red-500 text-slate-200":"bg-white border-slate-200 focus:border-red-500 shadow-sm"])},[...x[18]||(x[18]=[s("option",{value:"asc"},"Sequence: A to Z",-1),s("option",{value:"desc"},"Sequence: Z to A",-1)])],2),[[it,m.value]]),x[19]||(x[19]=s("div",{class:"absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none text-red-500"},[s("svg",{class:"w-5 h-5 group-hover:rotate-180 transition-transform duration-500",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[s("path",{d:"M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4","stroke-width":"2.5","stroke-linecap":"round","stroke-linejoin":"round"})])],-1))]),s("button",{onClick:i,class:"h-[60px] w-full px-1 rounded-2xl bg-red-600 hover:bg-red-700 text-white transition-all duration-300 flex items-center justify-center gap-3 shadow-lg shadow-red-600/20 group font-black uppercase tracking-widest text-[10px]"},[...x[20]||(x[20]=[s("svg",{xmlns:"http://www.w3.org/2000/svg",class:"w-4 h-4 group-hover:rotate-180 transition-transform duration-500",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},[s("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"3",d:"M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"})],-1),s("span",{class:"whitespace-nowrap"},"Reset",-1)])])])])],2),s("div",rp,[s("div",{class:w(["absolute inset-0 h-[1px] my-auto",e.isDark?"bg-white/5":"bg-slate-200"])},null,2),x[22]||(x[22]=s("div",{class:"absolute h-[2px] w-[30%] bg-gradient-to-r from-transparent via-blue-500 to-transparent animate-shimmer"},null,-1)),s("div",{class:w(["relative px-6 py-1 rounded-full border-2 text-[8px] font-black uppercase tracking-[0.4em] transition-all",e.isDark?"bg-[#020617] border-white/10 text-slate-500":"bg-transparent-50 border-slate-200 text-slate-400"])}," Xtall Versi Indonesia ",2)]),s("main",cp,[(T(!0),K($,null,me(ne.value,(F,we)=>(T(),K("div",{key:F.code,class:"flex flex-col lg:grid lg:grid-cols-12 gap-6 items-stretch animate-entry",style:Pt({animationDelay:we*70+"ms"})},[s("div",up,[R(F)?(T(),K("div",{key:0,onClick:pe=>oe(R(F).name),class:w(["flex-shrink-0 w-[200px] lg:w-full p-5 rounded-[1.5rem] border-2 cursor-pointer transition-all duration-500 relative overflow-hidden group shadow-xl",e.isDark?"bg-slate-900/300 border-white/65 hover:border-cyan-500/50 hover:bg-slate-900/60":"bg-white border-slate-200 hover:border-cyan-400"])},[x[23]||(x[23]=dn('<div class="absolute left-0 top-0 h-full w-2 bg-gradient-to-b from-sky-400 to cyan-500 to-blue-600 opacity-40 group-hover:opacity-100 transition-opacity" data-v-7bbcb7cc></div><div class="flex items-center gap-2 mb-2" data-v-7bbcb7cc><svg class="w-3 h-3 text-cyan-500" fill="currentColor" viewBox="0 0 24 24" data-v-7bbcb7cc><path d="M11 9l1.42 1.42L8.83 14H18V4h2v12H8.83l3.59 3.58L11 21l-6-6 6-6z" data-v-7bbcb7cc></path></svg><span class="text-[9px] font-black uppercase text-cyan-500 tracking-widest" data-v-7bbcb7cc>Previous</span></div>',2)),s("p",{class:w(["text-xs font-bold truncate group-hover:translate-x-1 transition-transform duration-300",e.isDark?"text-slate-300":"text-slate-700"])},O(R(F).name),3),x[24]||(x[24]=s("div",{class:"absolute bottom-[-10px] right-[-10px] text-4xl opacity-[0.03] group-hover:scale-125 transition-transform"},"🧬",-1))],10,dp)):(T(),K("div",pp,[...x[25]||(x[25]=[s("div",{class:"w-[2px] h-full bg-gradient-to-b from-transparent via-slate-500 to-transparent"},null,-1)])]))]),s("div",fp,[s("div",{class:w(["absolute -inset-1 rounded-[3rem] blur-2xl opacity-0 group-hover:opacity-20 transition-opacity duration-700",F.type==="UPGRADE"?"bg-purple-600":"bg-blue-600"])},null,2),s("div",{class:w(["h-full relative rounded-[2.5rem] border-2 overflow-hidden transition-all duration-500 shadow-2xl",e.isDark?"bg-[#0b1226]/90 border-white/80 group-hover:border-white/80":"bg-white border-slate-200 group-hover:border-blue-400"])},[s("div",mp,[s("div",gp,[s("div",hp,[x[26]||(x[26]=s("div",{class:"absolute inset-0 bg-gradient-to-tr from-sky-600 to-purple-600 rounded-[2rem] blur-xl opacity-20 group-hover:opacity-40 animate-pulse"},null,-1)),s("div",{class:w(["relative w-24 h-24 md:w-32 md:h-32 rounded-[2.5rem] border-2 flex items-center justify-center shadow-inner transition-all duration-700 group-hover:rotate-[10deg] group-hover:scale-110",e.isDark?"bg-slate-950 border-white/70":"bg-slate-50 border-slate-200"])},[s("img",{src:S(F),class:"w-16 h-16 md:w-20 md:h-20 object-contain drop-shadow-[0_15px_15px_rgba(0,0,0,0.4)]",alt:F.type},null,8,bp)],2),s("div",{class:w(["absolute -bottom-2 -right-2 w-10 h-10 rounded-2xl border-2 flex items-center justify-center text-[10px] font-black",E(F.type)])},O(F.type.charAt(0)),3)]),s("div",Ap,[s("div",kp,[x[27]||(x[27]=s("div",{class:"flex flex-wrap items-center gap-3"},null,-1)),s("h3",{class:w(["text-2xl md:text-4xl font-[1000] tracking-tighter leading-none transition-all duration-500 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-blue-400 group-hover:to-purple-400",Q(F)])},O(F.name),3)]),s("div",{class:w(["p-6 rounded-3xl border-2 transition-all duration-500 group-hover:scale-[1.02]",e.isDark?"bg-white/[0.02] border-white/5 group-hover:bg-white/[0.04]":"bg-slate-50 border-slate-100"])},[s("div",vp,[(T(!0),K($,null,me(Y(F.view),(pe,Te)=>(T(),K("div",{key:Te,class:"flex items-center gap-4 group/item"},[pe.includes("Dengan")?Ie("",!0):(T(),K("div",xp)),s("p",{class:w(["text-xs md:text-sm font-bold tracking-tight transition-all duration-300",pe.includes("Dengan")?"text-green-500 italic":pe.includes("-")?"text-red-500":e.isDark?"text-slate-300 group-hover/item:text-white":"text-slate-600 group-hover/item:text-slate-900"])},O(pe),3)]))),128))])],2)])])]),s("div",{class:w(["px-8 py-5 border-t-2 flex flex-col sm:flex-row justify-between items-center gap-4",e.isDark?"bg-white/[0.02] border-white/5":"bg-slate-50 border-slate-100"])},[s("div",yp,[s("div",wp,[s("span",{class:w(["text-[10px] font-black tracking-widest transition-colors",e.isDark?"text-slate-400":"text-slate-500"])}," TYPE XTALL ",2),s("span",{class:w(["text-[9px] font-black px-2.5 py-0.5 rounded-full border transition-all uppercase tracking-tighter",E(F.type)])},O(F.type),3)]),x[28]||(x[28]=s("div",{class:"h-8 w-[1px] bg-white/10 hidden sm:block"},null,-1))]),xe(ge,{to:"/xtall/"+F.code,class:"w-full sm:w-auto px-6 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-[10px] font-black uppercase tracking-widest shadow-lg shadow-blue-600/20 hover:shadow-blue-600/40 hover:-translate-y-0.5 transition-all duration-300 text-center"},{default:Ye(()=>[...x[29]||(x[29]=[Je(" Details ",-1)])]),_:1},8,["to"])],2)],2)]),s("div",Pp,[V(F).length?(T(!0),K($,{key:0},me(V(F),pe=>(T(),K("div",{key:pe.code,onClick:Te=>oe(pe.name),class:w(["flex-shrink-0 w-[200px] lg:w-full p-5 rounded-[1.5rem] border-2 cursor-pointer transition-all duration-500 relative overflow-hidden group shadow-xl",e.isDark?"bg-slate-900/30 border-white/65 hover:border-purple-500/50 hover:bg-slate-900/60":"bg-white border-slate-200 hover:border-purple-400"])},[x[30]||(x[30]=dn('<div class="absolute right-0 top-0 h-full w-2 bg-gradient-to-b from-purple-400 to-pink-600 to-yellow-700 opacity-40 group-hover:opacity-100 transition-opacity" data-v-7bbcb7cc></div><div class="flex items-center justify-end gap-2 mb-2 text-right" data-v-7bbcb7cc><span class="text-[9px] font-black uppercase text-purple-500 tracking-widest" data-v-7bbcb7cc>Next Upgrade</span><svg class="w-3 h-3 text-purple-500 rotate-180" fill="currentColor" viewBox="0 0 24 24" data-v-7bbcb7cc><path d="M11 9l1.42 1.42L8.83 14H18V4h2v12H8.83l3.59 3.58L11 21l-6-6 6-6z" data-v-7bbcb7cc></path></svg></div>',2)),s("p",{class:w(["text-xs font-bold truncate text-right group-hover:-translate-x-1 transition-transform duration-300",e.isDark?"text-slate-300":"text-slate-700"])},O(pe.name),3),x[31]||(x[31]=s("div",{class:"absolute bottom-[-10px] left-[-10px] text-4xl opacity-[0.03] group-hover:scale-125 transition-transform"},"🚀",-1))],10,Mp))),128)):(T(),K("div",Dp,[...x[32]||(x[32]=[s("div",{class:"w-[2px] h-full bg-gradient-to-b from-transparent via-slate-500 to-transparent"},null,-1)])]))])],4))),128)),G.value.length===0?(T(),K("div",Rp,[x[33]||(x[33]=dn('<div class="inline-flex relative mb-8" data-v-7bbcb7cc><div class="absolute inset-0 bg-blue-500 blur-3xl opacity-20 animate-ping" data-v-7bbcb7cc></div><div class="text-8xl relative" data-v-7bbcb7cc>🔎</div></div><h2 class="text-3xl font-[1000] uppercase italic tracking-tighter" data-v-7bbcb7cc>Xtall not found</h2><p class="text-slate-500 font-bold uppercase tracking-[0.3em] text-xs mt-4" data-v-7bbcb7cc>Search xtall name with correct Indonesian name.</p>',3)),s("button",{onClick:y,class:"mt-8 px-8 py-3 bg-white/5 hover:bg-white/10 border border-blue/10 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all"},"Reset")])):Ie("",!0),s("div",Sp,[Me.value>1&&d.value<1e3?(T(),K("nav",Cp,[s("button",{onClick:x[3]||(x[3]=F=>u.value--),disabled:u.value===1,class:"w-14 h-14 flex items-center justify-center rounded-2xl border-2 font-black disabled:opacity-30 transition-all duration-300 shadow-sm isDark ? 'bg-slate-900 border-white/10 text-slate-400 hover:border-blue-500 hover:text-blue-500' : 'bg-white border-slate-200 text-slate-400 hover:border-blue-500 hover:text-blue-500'"}," « ",8,Ep),s("div",Tp,[(T(!0),K($,null,me(Le.value,F=>(T(),K($,{key:F},[F!=="..."?(T(),K("button",{key:0,onClick:we=>u.value=F,class:w(["w-14 h-14 rounded-2xl font-black text-lg transition-all duration-300 border-2 flex items-center justify-center",u.value===F?"bg-blue-600 border-blue-600 text-white shadow-[0_10px_25px_rgba(37,99,235,0.4)] scale-110 -translate-y-1":e.isDark?"bg-slate-900 border-white/5 text-blue-500 hover:border-blue-500":"bg-white border-slate-100 text-blue-600 hover:border-blue-200 shadow-sm"])},O(F),11,_p)):(T(),K("span",Kp,"..."))],64))),128))]),s("button",{onClick:x[4]||(x[4]=F=>u.value++),disabled:u.value===Me.value,class:"w-14 h-14 flex items-center justify-center rounded-2xl border-2 font-black disabled:opacity-30 transition-all duration-300 shadow-sm isDark ? 'bg-slate-900 border-white/10 text-slate-400 hover:border-blue-500 hover:text-blue-500' : 'bg-white border-slate-200 text-slate-400 hover:border-blue-500 hover:text-blue-500'"}," » ",8,Ip)])):Ie("",!0),d.value<100?(T(),K("button",{key:1,onClick:x[5]||(x[5]=F=>d.value=9999),class:"group relative px-10 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl overflow-hidden transition-all duration-500 hover:scale-105 hover:shadow-[0_15px_40px_rgba(37,99,235,0.4)] shadow-xl"},[...x[34]||(x[34]=[s("div",{class:"absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300"},null,-1),s("span",{class:"relative text-xs font-[1000] text-white uppercase tracking-[0.3em] italic"},"Explore All",-1)])])):Ie("",!0),s("div",Bp,[x[35]||(x[35]=s("div",{class:"h-[1px] w-12 bg-blue-500/30"},null,-1)),s("p",Np,"Page "+O(u.value)+" of "+O(Me.value),1),x[36]||(x[36]=s("div",{class:"h-[1px] w-12 bg-blue-500/30"},null,-1))])])])]),s("div",Op,[s("div",{class:w(["px-6 py-3 rounded-2xl border-2 backdrop-blur-xl transition-all duration-500",e.isDark?"bg-slate-900/80 border-white/10":"bg-white/80 border-slate-200 shadow-2xl"])},[...x[37]||(x[37]=[s("div",{class:"flex items-center gap-4"},[s("div",{class:"w-2 h-2 rounded-full bg-blue-500 animate-pulse"}),s("span",{class:"text-[9px] font-black uppercase tracking-widest opacity-60"},"Versi Nama Indonesia")],-1)])],2)])],2)}}},Gp=Vt(Lp,[["__scopeId","data-v-7bbcb7cc"]]),Vl=310,Va={"Custom Experience Value":0,"Nightmare Crystal (Stack)":297e3,"Lapin's Soul (Piece)":344e3,"Parasited Crystal (Stack)":38e4,"Free from Infesters! (2k f/k)":15e6,"Defeat Metal Stinger (x100)":324e4,"Minotaur Skin (Stack)":999900,"Cracked Platinum Armguard (Stack)":677e3},Ja={"Chapter 1":"","First Time Visit":30,"Straye Brother and Sister":80,"A Golem on a Rampage":730,"The Goddess of Wisdom":2050,"The Dragon's Den":4700,"The Ruined Temple":9330,"The First Magic Stone":16700,"Purification Incense":27900,"The Dragon and Black Crystal":43e3,"Chapter 2":"","The Merchant Girl":64e3,"Where Are the Gems?":92e3,"Who is the Black Knight?!":118200,"Trials in the Palace":149e3,"The Moon Wizard":172e3,"The Follower and Hater":227e3,"The Wizard's Cave":24e4,"The Star Wizard":255e3,"Chapter 3":"","The Invincible... Enemy??":27e4,"The Ancient Empress":284e3,"The Culprit":319e3,"Fate of the Fortress":335e3,"Memory in the Lost Town":398e3,"The Stolen Sorcery Gem":417e3,"Living with a Dragon":462300,"Monsters from Outerworld":54e4,"Chapter 4":"","The Mage Diels":562e3,"Journey for Reconstruction":585e3,"The Sacred Gem in Akaku":71e4,"The King of Darkan":74e4,"The Lurking Evil":803e3,"Find the False Black Knight!":913e3,"Technista's Movement":1e6,"The Falling Feather of Death":11e5,"Chapter 5":"","In The Unknown Darkness":115e4,"The Charm":131e4,"Parching Dark Mirror":137e4,"Fierce Battle in the Garden":155e4,"A Light in the Darkness":175e4,"The Ones Nesting in the Manor":197e4,"The Dark Castle":221e4,"To The Living World":222e4,"Chapter 6":"","Demi Machina":26e5,"The Town of Pax Faction":27e5,"Mechanical Heart":28e5,"Black Knights of Lyark":282e4,"The Mysterious Artifact":303e4,"Truth of the Artifact":3099e3,"The Price of Treachery":332e4,"The Blasphemous Factory":364e4,"Mystery of the Black Knights":402e4,"Chapter 7":"","Monster's Forest":473e4,"The Underground Town":482e4,"The Elves in Lyark":507e4,"The Mad Laboratory":55e5,"Tragedy in the Jail":6e6,"Calamity in Droma Square":64e5,"Head for Ultimea Palace":69e5,"The Chaotic Truth":74e5,"Chapter 8":"","The Mine Where Monsters Lurk":84e5,"The Mysterious Shadow":85e5,"The New Diel Country":86e5,"The Ruins of the Gods":88e5,"The Former God of Justice":91e5,"The Remaining Thrones in the Shrine":97e5,"Gods' Whereabouts":104e5,"The Wait at Specia's Shrine":111e5,"The Warden of Ice & Snow":118e5,"At Mountains' End":125e5,"Chapter 9":"","Deadly Road to Eldenbaum":158e5,"Unforeseen Traps":171e5,"Traces of Technological Progress":182e5,"An Unexpected Acquaintance":192e5,"Front Line Base Operation":203e5,"Strategy to Redeem the Treetop Harbor":215e5,"The Teleporter Left Behind":227e5,"The Man Who Seeks Death":239e5,"The Battle to Recapture Eldenbaum":25e6,"A New Beginning":13e6,"Chapter 10":"","Off to the Fateful Land":26e6,"The Inhabitants Under the Cliff":274e5,"The Nightmare Returns":288e5,"The Whereabouts of the Missing Monks":302e5,"The Goddess of Justice and the Squatters":316e5,"Navigator of the Ark":331e5,"Witch in the Woods":346e5,"The Duel in Nov Diela":362e5,"Chapter 11":"","Flying the Ark":378e5,"Land of the Unknown":49e6,"The Strolling Forest":51e6,"Eumanos the Forest Dwellers":534e5,"A Sproutling is Born":557e5,"The Blessing-Bearer":581e5,"Intense Battle in Coenubia's Stronghold":605e5,"The Shadow of a Smoky Mountain":63e6,"The Weredragons & the Underground World":655e5,"Chapter 12":"","The Sky with a Ceiling":734e5,"Rivalry Between Dragons and Weredragons":763e5,"Weredragon Couple and a Baby":793e5,"Weredragons' Vital Point":823e5,"Intense Battle in Propulsion System":853e5,"Discovering a New Technology":442e5,"Ark Repair":927e5,"Weredragon Dispute":96e6,"Cocoon in the Ice Wall":993e5,"Chapter 13":"","Underwater Inhabitants":1126e5,"Water Dome":1165e5,"Underwater City":602e5,"The Thing in the Abandoned District":1258e5,"Shadow from the Abyss":1299e5,"The Ruthless Council":67e6,"Mysterious Entity in the Little Shrine":1399e5,"The Great Battle Underwater":1442e5,"Chapter 14":"","Crisis in the Sky":1591e5,"The Surviving Siblings":164e6,"Chaotic Situation":1689e5,"The Bitter Truth":1738e5,"The Uncouth Rana Prince":1788e5,"Mutant Coenubia Village":1839e5,"Fierce Battle with Mutant Lixis":189e6,"Chapter 15":"","Ark Crisis":2105e5,"Coastal Clash":2163e5,"Unda's Rescue Operation":2222e5},Gt=e=>Math.floor(.025*Math.pow(e,4)+2*e),Up=(e,t,n)=>{let a=Math.floor((1-t/100)*Gt(e));for(let i=e+1;i<n;i++)a+=Gt(i);return a},Wa=(e,t,n)=>{let a=n,i=(1-t/100)*Gt(e);if(n<i){let l=t/100*Gt(e)+n;return[e,Math.floor(100*l/Gt(e))]}else{a-=i;let l=e+1;for(;Gt(l)<=a;)a-=Gt(l),l+=1;let o=Math.floor(100*a/Gt(l));return[l,o]}},Hp={class:"space-y-8 animate-in fade-in duration-700 max-w-6xl mx-auto pb-20 px-4"},jp={class:"flex flex-col items-center gap-6 animate-bounce-slow"},Fp={class:"grid grid-cols-1 lg:grid-cols-3 gap-8"},Vp={class:"lg:col-span-2 space-y-6"},Jp={class:"grid grid-cols-1 md:grid-cols-3 gap-6 mb-8"},Wp={class:"group"},Qp={class:"group"},qp={class:"group"},zp={key:0,class:"space-y-8 animate-in slide-in-from-top-2"},$p={class:"grid grid-cols-1 md:grid-cols-2 gap-6 pt-8 border-t border-white/10"},Xp={class:"relative group select-container"},Zp={class:"relative"},Yp=["value"],ef={class:"relative group select-container"},tf={class:"relative"},nf=["value"],af={class:"flex flex-wrap gap-8 ml-2"},lf={class:"flex items-center gap-3 cursor-pointer group active:scale-95 transition-transform"},sf={class:"flex items-center gap-3 cursor-pointer group active:scale-95 transition-transform"},of={key:1,class:"space-y-8 animate-in slide-in-from-top-2"},rf={class:"grid grid-cols-1 md:grid-cols-2 gap-6 pt-8 border-t border-white/10"},cf={class:"relative group select-container"},uf={class:"relative"},df=["value"],pf={class:"lg:col-span-1"},ff={class:"space-y-6 sticky top-8"},mf={class:"relative z-10 space-y-8"},gf={class:"result-item"},hf={class:"text-2xl font-black tabular-nums tracking-tighter"},bf={class:"pt-8 border-t border-white/20 result-item"},Af={class:"text-[10px] font-black tracking-widest opacity-60 uppercase mb-2"},kf={class:"flex items-baseline gap-2"},vf={class:"text-6xl font-black italic tracking-tighter drop-shadow-lg block"},xf={class:"text-xl font-bold opacity-70"},yf={class:"bg-black/20 p-4 rounded-2xl border border-white/10 backdrop-blur-sm result-item"},wf={class:"text-sm font-black tabular-nums tracking-wide"},Pf={class:"absolute -right-6 -bottom-6 text-[12rem] font-black italic opacity-10 pointer-events-none uppercase tracking-tighter transition-transform duration-700 deco-text"},Mf={class:"space-y-2 max-h-[300px] overflow-y-auto pr-2 custom-scroll"},Df={class:"text-[11px] font-black opacity-40"},Rf={class:"text-right"},Sf={class:"text-[10px] font-bold opacity-50 ml-1"},Cf={__name:"CalculatorMQ",props:{isDark:Boolean},setup(e){const t=se("mq"),n=se(1),a=se(0),i=se(Vl),l=se(!0),o=se(!1),r=Object.keys(Ja),c=se(1),p=se(r.length-1),u=se(Object.keys(Va)[1]),d=se(1),m=te(()=>{let v=[],h=0;return r.forEach((A,y)=>{A.startsWith("Chapter")?h++:Ja[A]!==""&&v.push({id:y,label:`CH${h} - ${A}`})}),v}),b=te(()=>{const v=Number(n.value)||1,h=Number(a.value)||0,A=Number(i.value)||Vl,y=Up(v,h,A);let S=0;for(let Q=c.value;Q<=p.value;Q++){const Y=Ja[r[Q]];typeof Y=="number"&&(S+=Y),r[Q].includes("Coenubia")&&!l.value&&(S+=125e5)}const[E,R]=Wa(v,h,S);let V=[];if(o.value&&S>0){let Q=v,Y=h;for(let oe=1;oe<=20;oe++){const[G,ne]=Wa(Q,Y,S);if(V.push({run:oe,lv:G,p:ne}),Q=G,Y=ne,Q>=A)break}}const ee=(Va[u.value]||0)*(d.value||0),[re,Pe]=Wa(v,h,ee);return{xpNeeded:y,totalMqXP:S,resLv:E,resP:R,diaryRuns:V,sqLv:re,sqPercent:Pe,sqXP:ee}});return(v,h)=>(T(),K("div",Hp,[s("div",jp,[h[11]||(h[11]=s("div",{class:"text-center"},[s("h1",{class:"text-5xl md:text-6xl font-black italic tracking-tighter uppercase text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 drop-shadow-2xl"}," MQ Calculator "),s("p",{class:"text-[10px] font-bold opacity-50 tracking-[0.4em] uppercase animate-pulse"},"Timi DB System")],-1)),s("div",{class:w(["p-1 rounded-full flex gap-1 border backdrop-blur-md transition-all shadow-xl",e.isDark?"bg-white/5 border-white/10":"bg-slate-200/50 border-slate-300"])},[s("button",{onClick:h[0]||(h[0]=A=>t.value="mq"),class:w(["tab-btn",t.value==="mq"?"tab-active":""])},"Main Quest",2),s("button",{onClick:h[1]||(h[1]=A=>t.value="npc"),class:w(["tab-btn",t.value==="npc"?"tab-active":""])},"NPC Quest",2)],2)]),s("div",Fp,[s("div",Vp,[s("div",{class:w(["p-8 rounded-[2.5rem] border backdrop-blur-md shadow-2xl transition-all duration-500",e.isDark?"bg-slate-900/40 border-white/10":"bg-white/60 border-white/40"])},[s("div",Jp,[s("div",Wp,[h[12]||(h[12]=s("label",{class:"label-text"},"Current Lv",-1)),ve(s("input",{"onUpdate:modelValue":h[2]||(h[2]=A=>n.value=A),type:"number",class:w(["input-style",e.isDark?"dark-input":"light-input"])},null,2),[[ze,n.value,void 0,{number:!0}]])]),s("div",Qp,[h[13]||(h[13]=s("label",{class:"label-text"},"Percent %",-1)),ve(s("input",{"onUpdate:modelValue":h[3]||(h[3]=A=>a.value=A),type:"number",class:w(["input-style",e.isDark?"dark-input":"light-input"])},null,2),[[ze,a.value,void 0,{number:!0}]])]),s("div",qp,[h[14]||(h[14]=s("label",{class:"label-text text-pink-500"},"Target Lv",-1)),ve(s("input",{"onUpdate:modelValue":h[4]||(h[4]=A=>i.value=A),type:"number",class:w(["input-style",e.isDark?"dark-input":"light-input"])},null,2),[[ze,i.value,void 0,{number:!0}]])])]),t.value==="mq"?(T(),K("div",zp,[s("div",$p,[s("div",Xp,[h[16]||(h[16]=s("label",{class:"label-text text-indigo-400"},"Start From",-1)),s("div",Zp,[ve(s("select",{"onUpdate:modelValue":h[5]||(h[5]=A=>c.value=A),class:w(["input-style custom-select pr-10",e.isDark?"dark-input":"light-input"])},[(T(!0),K($,null,me(m.value,A=>(T(),K("option",{key:A.id,value:A.id,class:"dropdown-item"},O(A.label),9,Yp))),128))],2),[[it,c.value]]),h[15]||(h[15]=s("div",{class:"select-arrow text-indigo-500"},[s("svg",{xmlns:"http://www.w3.org/2000/svg",class:"h-4 w-4",viewBox:"0 0 20 20",fill:"currentColor"},[s("path",{"fill-rule":"evenodd",d:"M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z","clip-rule":"evenodd"})])],-1))])]),s("div",ef,[h[18]||(h[18]=s("label",{class:"label-text text-indigo-400"},"End At",-1)),s("div",tf,[ve(s("select",{"onUpdate:modelValue":h[6]||(h[6]=A=>p.value=A),class:w(["input-style custom-select pr-10",e.isDark?"dark-input":"light-input"])},[(T(!0),K($,null,me(m.value,A=>(T(),K("option",{key:A.id,value:A.id,class:"dropdown-item"},O(A.label),9,nf))),128))],2),[[it,p.value]]),h[17]||(h[17]=s("div",{class:"select-arrow text-indigo-500"},[s("svg",{xmlns:"http://www.w3.org/2000/svg",class:"h-4 w-4",viewBox:"0 0 20 20",fill:"currentColor"},[s("path",{"fill-rule":"evenodd",d:"M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z","clip-rule":"evenodd"})])],-1))])])]),s("div",af,[s("label",lf,[ve(s("input",{type:"checkbox","onUpdate:modelValue":h[7]||(h[7]=A=>l.value=A),class:"w-5 h-5 rounded border-indigo-500 accent-indigo-600 cursor-pointer"},null,512),[[Pl,l.value]]),h[19]||(h[19]=s("span",{class:"text-[11px] font-black uppercase tracking-widest opacity-70 group-hover:opacity-100 transition-opacity"},"Skip Pre-Venena",-1))]),s("label",sf,[ve(s("input",{type:"checkbox","onUpdate:modelValue":h[8]||(h[8]=A=>o.value=A),class:"w-5 h-5 rounded border-purple-500 accent-purple-600 cursor-pointer"},null,512),[[Pl,o.value]]),h[20]||(h[20]=s("span",{class:"text-[11px] font-black uppercase tracking-widest opacity-70 group-hover:opacity-100 transition-opacity"},"Spam Diaries",-1))])])])):(T(),K("div",of,[s("div",rf,[s("div",cf,[h[22]||(h[22]=s("label",{class:"label-text text-emerald-400"},"Select Quest",-1)),s("div",uf,[ve(s("select",{"onUpdate:modelValue":h[9]||(h[9]=A=>u.value=A),class:w(["input-style custom-select pr-10",e.isDark?"dark-input":"light-input"])},[(T(!0),K($,null,me(We(Va),(A,y)=>(T(),K("option",{key:y,value:y,class:"dropdown-item"},O(y),9,df))),128))],2),[[it,u.value]]),h[21]||(h[21]=s("div",{class:"select-arrow text-emerald-500"},[s("svg",{xmlns:"http://www.w3.org/2000/svg",class:"h-4 w-4",viewBox:"0 0 20 20",fill:"currentColor"},[s("path",{"fill-rule":"evenodd",d:"M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z","clip-rule":"evenodd"})])],-1))])]),s("div",null,[h[23]||(h[23]=s("label",{class:"label-text text-emerald-400"},"Amount (Stack/Times)",-1)),ve(s("input",{"onUpdate:modelValue":h[10]||(h[10]=A=>d.value=A),type:"number",class:w(["input-style",e.isDark?"dark-input":"light-input"])},null,2),[[ze,d.value,void 0,{number:!0}]])])])]))],2)]),s("div",pf,[s("div",ff,[s("div",{class:w(["p-8 rounded-[3rem] shadow-2xl text-white relative overflow-hidden flex flex-col justify-between transition-all duration-500 result-card-interactive",t.value==="mq"?"bg-gradient-to-br from-indigo-600 to-purple-800 shadow-indigo-500/30":"bg-gradient-to-br from-emerald-600 to-teal-800 shadow-emerald-500/30"])},[s("div",mf,[s("div",gf,[h[24]||(h[24]=s("p",{class:"text-[10px] font-black tracking-widest opacity-60 uppercase mb-1"},"XP Required to Target",-1)),s("h3",hf,O(b.value.xpNeeded.toLocaleString()),1)]),s("div",bf,[s("p",Af,O(t.value==="mq"?"Result After 1 Run":"Result After Turn-in"),1),s("div",kf,[s("span",vf," Lv "+O(t.value==="mq"?b.value.resLv:b.value.sqLv),1),s("span",xf,O(t.value==="mq"?b.value.resP:b.value.sqPercent)+"% ",1)])]),s("div",yf,[h[25]||(h[25]=s("p",{class:"text-[9px] font-bold opacity-50 uppercase tracking-widest mb-1"},"Total XP Gained",-1)),s("p",wf,O((t.value==="mq"?b.value.totalMqXP:b.value.sqXP).toLocaleString())+" XP ",1)])]),s("div",Pf,O(t.value),1)],2),t.value==="mq"&&o.value&&b.value.diaryRuns.length>0?(T(),K("div",{key:0,class:w(["p-6 rounded-[2.5rem] border backdrop-blur-md animate-in slide-in-from-bottom-4",e.isDark?"bg-white/5 border-white/10":"bg-white border-slate-200 shadow-lg"])},[h[26]||(h[26]=s("p",{class:"text-[10px] font-black uppercase tracking-widest opacity-50 mb-4 px-2"},"Diary Projection",-1)),s("div",Mf,[(T(!0),K($,null,me(b.value.diaryRuns,A=>(T(),K("div",{key:A.run,class:"flex justify-between items-center p-3 rounded-xl hover:bg-indigo-500/10 transition-colors"},[s("span",Df,"RUN #"+O(A.run),1),s("div",Rf,[s("span",{class:w(["font-black",e.isDark?"text-white":"text-slate-800"])},"Lv "+O(A.lv),3),s("span",Sf,O(A.p)+"%",1)])]))),128))])],2)):Ie("",!0)])])])]))}},Ef=Vt(Cf,[["__scopeId","data-v-c84703e0"]]),Tf=280,Jl=54,_f=55,Wl=265,Kf=300,Kt=510,It=277,{floor:_e,min:If,max:Bf}=Math,Nf=(e,t,n,a,i)=>{const l=_e(n*(100+(i||0))/100+(a||0));return(e||0)+_e((t||0)/2)+_e(l/6)},Of=(e,t,n,a,i,l)=>{const o=_e(a*(100+(l||0))/100+(i||0)),r=(50+5*(e||0))/100,c=10+(t||0)-(n||0)+_e(o/10);return If(100,Bf(0,_e(r*c)))},Lf=(e,t,n,a,i)=>{let l=_e((e||0)*(1+(t||0)*.01+(n||0)*.02));const o=i;switch(a){case"Armor":l+=_e(o.VIT/10);break;case"1H Sword":case"Bow":l+=_e((o.DEX+o.STR)/20);break;case"2H Sword":l+=_e(o.STR/10);break;case"Bowgun":l+=_e(o.DEX/10);break;case"Staff":l+=_e(o.INT/10);break;case"Magic Device":l+=_e((o.INT+o.AGI)/20);break;case"Knuckle":l+=_e(o.AGI/10);break;case"Halberd":l+=_e((o.STR+o.AGI)/20);break;case"Katana":l+=_e((o.DEX+o.AGI)/20);break}return l},Gf={class:"relative z-10 w-full max-w-6xl mx-auto p-4 md:p-8 space-y-8"},Uf={class:"grid grid-cols-1 lg:grid-cols-12 gap-6 items-start"},Hf={class:"lg:col-span-4 space-y-6 animate-float"},jf={class:"grid grid-cols-2 gap-x-4 gap-y-5"},Ff={class:"block text-[9px] font-black text-slate-500 uppercase mb-1.5 ml-1"},Vf=["onUpdate:modelValue"],Jf={class:"mt-8 pt-6 border-t dark:border-white/5 border-slate-100 grid grid-cols-2 gap-3"},Wf={class:"block text-[8px] font-black text-slate-500 uppercase mb-1 ml-1"},Qf=["onUpdate:modelValue"],qf={class:"lg:col-span-4 space-y-6"},zf={class:"space-y-4"},$f={class:"relative group select-container"},Xf={class:"relative overflow-hidden rounded-xl"},Zf=["value"],Yf={class:"grid grid-cols-2 gap-4"},em={class:"group"},tm={class:"group"},nm={class:"space-y-3 pt-2"},am={class:"text-[9px] font-black text-slate-500 uppercase tracking-tighter group-hover:text-cyan-200"},im=["onUpdate:modelValue"],lm={class:"lg:col-span-4 space-y-6 animate-float-slow"},sm={class:"flex items-baseline gap-2"},om={class:"mt-6 w-full bg-slate-500/10 h-3 rounded-full overflow-hidden p-[2px]"},rm={class:"flex items-baseline gap-2"},cm={class:"text-8xl font-black italic tracking-tighter leading-none dark:text-white text-slate-900 hover:scale-105 transition-transform duration-700 block"},um={class:"space-y-4"},dm={class:"flex justify-between items-center text-[10px] font-black text-slate-500 uppercase border-b border-white/5 pb-3"},pm={key:0,class:"flex flex-col items-center justify-center gap-2 p-6 bg-rose-500/5 border border-rose-500/20 rounded-[2rem] text-rose-500 animate-shake shadow-[inset_0_0_20px_rgba(244,63,94,0.05)]"},fm={key:1,class:"group flex flex-col items-center justify-center gap-2 p-6 bg-gradient-to-br from-emerald-500/10 to-transparent border-2 border-emerald-500/20 rounded-[2rem] text-emerald-400 animate-pulse transition-all hover:border-emerald-500/50"},mm={__name:"BSCalculator",props:["isDark"],setup(e){const t=e,n=te(()=>["p-8 rounded-[2.5rem] border backdrop-blur-3xl transition-all duration-500",t.isDark?"bg-slate-950/60 border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)]":"bg-white/80 border-slate-200 shadow-xl"]),a=["Armor","1H Sword","2H Sword","Bow","Bowgun","Staff","Magic Device","Knuckle","Halberd","Katana"],i=bn({level:305,craftType:"Armor",stats:{STR:0,INT:0,VIT:0,DEX:0,AGI:0,TEC:0},eStr:0,eStrP:0,eDex:0,eDexP:0,prof:Tf,createSkill:10,itemDiff:Wl,basePot:Jl,careful:10,expert:10}),l=()=>{Object.keys(i.stats).forEach(p=>i.stats[p]=0),i.craftType==="Armor"?(i.stats.VIT=Kt,i.stats.TEC=It,i.itemDiff=Wl,i.basePot=Jl):(i.itemDiff=Kf,i.basePot=_f,["1H Sword","Bow","Bowgun"].includes(i.craftType)?(i.stats.DEX=Kt,i.stats.STR=It):i.craftType==="2H Sword"?(i.stats.STR=Kt,i.stats.DEX=It):i.craftType==="Staff"?(i.stats.INT=Kt,i.stats.TEC=It):i.craftType==="Magic Device"?(i.stats.INT=Kt,i.stats.AGI=It):i.craftType==="Knuckle"?(i.stats.AGI=Kt,i.stats.DEX=It):i.craftType==="Halberd"?(i.stats.STR=Kt,i.stats.AGI=It):i.craftType==="Katana"&&(i.stats.DEX=Kt,i.stats.AGI=It))};tn(()=>l());const o=te(()=>Nf(i.prof,i.stats.TEC,i.stats.DEX,i.eDex,i.eDexP)),r=te(()=>Of(i.createSkill,o.value,i.itemDiff,i.stats.STR,i.eStr,i.eStrP)),c=te(()=>Lf(i.basePot,i.careful,i.expert,i.craftType,i.stats));return(p,u)=>(T(),K("div",Gf,[u[17]||(u[17]=s("div",{class:"text-center py-4 animate-bounce-slow"},[s("h1",{class:"text-6xl font-black italic tracking-tighter uppercase text-transparent bg-clip-text bg-gradient-to-r from-slate-100 via-orange-400 to-slate-500 dark:from-white dark:via-orange-500 dark:to-slate-600 drop-shadow-[0_10px_10px_rgba(0,0,0,0.3)]"}," Blacksmith Calculator "),s("p",{class:"text-[10px] font-bold uppercase tracking-[0.5em] text-orange-500 mt-2 animate-pulse"},"Timi DB")],-1)),s("div",Uf,[s("div",Hf,[s("div",{class:w(n.value)},[u[3]||(u[3]=s("p",{class:"text-[10px] font-black uppercase tracking-widest text-orange-500/60 mb-6 border-b border-orange-500/10 pb-2"},"Character Parameters",-1)),s("div",jf,[(T(!0),K($,null,me(i.stats,(d,m)=>(T(),K("div",{key:m,class:"transition-all hover:scale-105"},[s("label",Ff,O(m),1),ve(s("input",{type:"number","onUpdate:modelValue":b=>i.stats[m]=b,class:"w-full bg-slate-500/5 border dark:border-white/10 border-slate-200 rounded-xl p-3 text-center font-black dark:text-white text-slate-900 outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all"},null,8,Vf),[[ze,i.stats[m],void 0,{number:!0}]])]))),128))]),s("div",Jf,[(T(),K($,null,me([["eStr","STR+"],["eStrP","STR%"],["eDex","DEX+"],["eDexP","DEX%"]],d=>s("div",{key:d[0]},[s("label",Wf,O(d[1]),1),ve(s("input",{type:"number","onUpdate:modelValue":m=>i[d[0]]=m,class:"w-full bg-orange-500/5 border dark:border-white/5 border-slate-200 rounded-lg p-2 text-center text-xs font-black text-orange-500 outline-none hover:shadow-[0_0_15px_rgba(249,115,22,0.2)] transition-all"},null,8,Qf),[[ze,i[d[0]],void 0,{number:!0}]])])),64))])],2)]),s("div",qf,[s("div",{class:w([n.value,"relative border-t-4 border-t-cyan-500/50 shadow-cyan-500/5"])},[u[8]||(u[8]=s("p",{class:"text-[10px] font-black uppercase tracking-widest text-cyan-400 mb-6 border-b border-cyan-500/10 pb-2"},"Crafting Configuration",-1)),s("div",zf,[s("div",$f,[u[5]||(u[5]=s("label",{class:"block text-[9px] font-black text-slate-500 uppercase mb-1.5 group-hover:text-cyan-400 transition-colors"},"Equipment Type",-1)),s("div",Xf,[ve(s("select",{"onUpdate:modelValue":u[0]||(u[0]=d=>i.craftType=d),onChange:l,class:"w-full bg-slate-500/10 border dark:border-white/10 border-slate-200 rounded-xl p-4 font-black dark:text-cyan-100 text-slate-900 outline-none cursor-pointer appearance-none transition-all focus:ring-4 focus:ring-cyan-500/10 focus:border-cyan-500 custom-select"},[(T(),K($,null,me(a,d=>s("option",{key:d,value:d,class:"dropdown-item"},O(d),9,Zf)),64))],544),[[it,i.craftType]]),u[4]||(u[4]=s("div",{class:"absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none text-cyan-500 group-hover:scale-125 transition-transform z-20"},[s("svg",{xmlns:"http://www.w3.org/2000/svg",class:"h-5 w-5",viewBox:"0 0 20 20",fill:"currentColor"},[s("path",{"fill-rule":"evenodd",d:"M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z","clip-rule":"evenodd"})])],-1))])]),s("div",Yf,[s("div",em,[u[6]||(u[6]=s("label",{class:"block text-[9px] font-black text-slate-500 uppercase mb-1.5 group-hover:text-cyan-400"},"Proficiency",-1)),ve(s("input",{type:"number","onUpdate:modelValue":u[1]||(u[1]=d=>i.prof=d),class:"w-full bg-slate-500/5 border dark:border-white/10 border-slate-200 rounded-xl p-3 text-center font-black dark:text-white outline-none focus:border-cyan-500 transition-all"},null,512),[[ze,i.prof,void 0,{number:!0}]])]),s("div",tm,[u[7]||(u[7]=s("label",{class:"block text-[9px] font-black text-slate-500 uppercase mb-1.5 group-hover:text-cyan-400"},"Player Lv",-1)),ve(s("input",{type:"number","onUpdate:modelValue":u[2]||(u[2]=d=>i.level=d),class:"w-full bg-slate-500/5 border dark:border-white/10 border-slate-200 rounded-xl p-3 text-center font-black dark:text-white outline-none focus:border-cyan-500 transition-all"},null,512),[[ze,i.level,void 0,{number:!0}]])])]),s("div",nm,[(T(),K($,null,me([["createSkill","Create Equipment"],["careful","Careful Creation"],["expert","Expert's Creation"]],d=>s("div",{key:d[0],class:"flex justify-between items-center bg-gradient-to-r from-slate-500/5 to-transparent p-4 rounded-2xl border border-transparent hover:border-cyan-500/30 hover:from-cyan-500/10 transition-all group"},[s("span",am,O(d[1]),1),ve(s("input",{type:"number","onUpdate:modelValue":m=>i[d[0]]=m,class:"w-10 bg-transparent text-right font-black text-cyan-400 outline-none group-hover:scale-125 transition-transform"},null,8,im),[[ze,i[d[0]],void 0,{number:!0}]])])),64))])])],2)]),s("div",lm,[s("div",{class:w([n.value,"relative overflow-hidden group shadow-2xl"])},[u[10]||(u[10]=s("div",{class:"absolute -right-10 -top-10 w-32 h-32 bg-orange-500/10 blur-[50px]"},null,-1)),u[11]||(u[11]=s("p",{class:"text-[10px] font-black text-orange-500 uppercase tracking-[0.3em] mb-4"},"Success Rate",-1)),s("div",sm,[s("span",{class:w(["text-8xl font-black italic tracking-tighter leading-none transition-all duration-700 hover:tracking-normal block",r.value>=100?"text-transparent bg-clip-text bg-gradient-to-br from-emerald-300 to-emerald-600 drop-shadow-[0_0_20px_rgba(52,211,153,0.5)]":"dark:text-white text-slate-900"])},O(r.value),3),u[9]||(u[9]=s("span",{class:"text-3xl font-black text-orange-500"},"%",-1))]),s("div",om,[s("div",{class:"h-full bg-gradient-to-r from-orange-600 via-yellow-400 to-emerald-400 transition-all duration-1000 ease-out rounded-full shadow-[0_0_15px_rgba(249,115,22,0.4)]",style:Pt({width:r.value+"%"})},null,4)])],2),s("div",{class:w([n.value,"border-l-4 border-l-cyan-500 relative overflow-hidden"])},[u[13]||(u[13]=s("div",{class:"absolute -left-10 -bottom-10 w-32 h-32 bg-cyan-500/10 blur-[50px]"},null,-1)),u[14]||(u[14]=s("p",{class:"text-[10px] font-black text-cyan-400 uppercase tracking-[0.3em] mb-4"},"Total Potential",-1)),s("div",rm,[s("span",cm,O(c.value),1),u[12]||(u[12]=s("span",{class:"text-2xl font-black text-cyan-500/50 uppercase text-[12px]"},"Pts",-1))])],2),s("div",{class:w(n.value)},[s("div",um,[s("div",dm,[s("span",null,"Diff Status: "+O(o.value)+" / "+O(i.itemDiff),1)]),o.value<i.itemDiff?(T(),K("div",pm,[...u[15]||(u[15]=[s("svg",{xmlns:"http://www.w3.org/2000/svg",class:"h-8 w-8",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},[s("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"})],-1),s("span",{class:"text-[10px] font-black uppercase tracking-widest"},"Low Difficulty",-1)])])):(T(),K("div",fm,[...u[16]||(u[16]=[s("svg",{xmlns:"http://www.w3.org/2000/svg",class:"h-8 w-8",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},[s("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"3",d:"M5 13l4 4L19 7"})],-1),s("span",{class:"text-[10px] font-black uppercase tracking-widest group-hover:scale-110 transition-transform"},"Ready to Craft",-1)])]))])],2)])])]))}},gm=Vt(mm,[["__scopeId","data-v-676556a4"]]),hm={class:"fixed inset-0 pointer-events-none z-0"},bm={key:0,class:"absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-blue-600/10 blur-[120px] rounded-full animate-pulse"},Am={key:1,class:"absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-purple-600/10 blur-[120px] rounded-full animate-pulse"},km={key:0,class:"relative z-10 max-w-5xl mx-auto p-6 md:p-20 animate-fade-in"},vm={class:"grid lg:grid-cols-12 gap-12 items-start"},xm={class:"lg:col-span-5 space-y-6 animate-slide-right"},ym=["src"],wm={class:"lg:col-span-7 space-y-8 animate-slide-left"},Pm={class:"flex items-center gap-4"},Mm={class:"text-[10px] font-black text-cyan-500 uppercase tracking-[0.5em]"},Dm={class:"space-y-5"},Rm={key:0,class:"mt-2.5 w-2 h-2 rounded-full bg-cyan-500 shadow-[0_0_8px_rgba(6,182,212,1)] group-hover/stat:scale-150 transition-transform flex-shrink-0"},Sm={class:"grid grid-cols-1 md:grid-cols-2 gap-6"},Cm={class:"text-sm font-bold flex items-center gap-2"},Em={class:"text-sm font-bold flex items-center gap-2 justify-between"},Tm={key:1,class:"h-screen flex items-center justify-center"},_m={__name:"XtallDetail",props:["id","isDark"],setup(e){const t=e,n=Wn(),a=te(()=>Ht.find(v=>String(v.code)===String(t.id))),i=v=>{if(!v)return"NORMAL";let h=v,A=0;for(;h.link&&A<10;){const y=Ht.find(S=>String(S.code)===String(h.link));if(y)h=y,A++;else break}return h.type?.toUpperCase()},l=v=>{const h=i(a.value);return v?.toUpperCase()==="UPGRADE"||v?.toUpperCase()==="ENHANCER"?"text-gray-400":{WEAPON:"text-red-500",ARMOR:"text-green-500",NORMAL:"text-sky-500",ADDITIONAL:"text-yellow-500",SPECIAL:"text-purple-500"}[h]||"text-cyan-500"},o=v=>{const h=i(a.value);return{NORMAL:"bg-blue-600",WEAPON:"bg-red-600",ARMOR:"bg-green-600",ADDITIONAL:"bg-yellow-600",SPECIAL:"bg-cyan-600"}[h]||"bg-cyan-600"},r=v=>{const h=v?.toUpperCase();return h==="UPGRADE"||h==="ENHANCER"?"bg-purple-600 text-white border-purple-400":({NORMAL:"bg-blue-600",ADDITIONAL:"bg-yellow-600",WEAPON:"bg-red-600",ARMOR:"bg-green-600",SPECIAL:"bg-cyan-600"}[h]||"bg-slate-700")+" text-white border-white/20"},c=v=>{const h=v?.toUpperCase();return h==="UPGRADE"||h==="ENHANCER"?`${i(a.value)} ENHANCER`:h},p=te(()=>a.value?.link?Ht.find(v=>String(v.code)===String(a.value.link)):null),u=te(()=>a.value?Ht.find(v=>String(v.link)===String(a.value.code)):null),d=v=>{n.push(`/xtall/${v}`)};Mt(()=>t.id,()=>{window.scrollTo({top:0,behavior:"smooth"})});const m=v=>v?Array.isArray(v)?v:v.split(/,|\n/).map(h=>h.trim()).filter(h=>h):[],b=v=>{const h=v?.toUpperCase(),A=i(a.value);return h==="UPGRADE"||h==="ENHANCER"?{NORMAL:Hn,WEAPON:Ii,ARMOR:Bi,ADDITIONAL:Ni,SPECIAL:Oi}[A]||Hn:{NORMAL:Un,WEAPON:Ei,ARMOR:_i,ADDITIONAL:Ki,SPECIAL:Ti}[A]||Un};return(v,h)=>(T(),K("div",{class:w(["min-h-screen relative overflow-hidden font-sans transition-all duration-700",e.isDark?"bg-[#020617] text-slate-200":"bg-slate-50 text-slate-900"])},[s("div",hm,[s("div",{class:w(["absolute inset-0 bg-[url('/images/logo.png')] bg-center bg-no-repeat bg-[length:60%_auto] opacity-[0.03]",e.isDark?"brightness-200":"invert opacity-[0.02]"])},null,2),e.isDark?(T(),K("div",bm)):Ie("",!0),e.isDark?(T(),K("div",Am)):Ie("",!0)]),a.value?(T(),K("div",km,[s("button",{onClick:h[0]||(h[0]=A=>v.$router.push("/xtall")),class:"group flex items-center gap-3 mb-10 transition-all hover:-translate-x-2"},[...h[3]||(h[3]=[s("div",{class:"w-10 h-10 rounded-full border-2 border-cyan-500/50 flex items-center justify-center group-hover:bg-cyan-500 transition-all shadow-[0_0_15px_rgba(6,182,212,0.3)]"},[s("svg",{class:"w-5 h-5 text-cyan-500 group-hover:text-white",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[s("path",{d:"M15 19l-7-7 7-7","stroke-width":"3"})])],-1),s("span",{class:"text-[10px] font-black uppercase tracking-[0.3em] opacity-60 group-hover:opacity-100 group-hover:text-cyan-500"},"Back to Database",-1)])]),s("div",vm,[s("div",xm,[s("div",{class:w(["relative aspect-square rounded-[3.5rem] border-4 flex items-center justify-center overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.4)] transition-all duration-700 group",e.isDark?"bg-slate-900 border-white/20":"bg-white border-slate-300"])},[s("div",{class:w(["absolute inset-0 opacity-30 blur-3xl animate-pulse transition-colors duration-700",o(a.value.type)])},null,2),s("img",{src:b(a.value.type),class:"relative w-48 h-48 md:w-64 md:h-64 object-contain drop-shadow-[0_10px_20px_rgba(0,0,0,0.5)] transition-transform duration-700 group-hover:scale-110 animate-float"},null,8,ym),s("div",{class:w(["absolute bottom-8 px-6 py-2 rounded-2xl border-2 font-black text-[10px] tracking-widest uppercase shadow-2xl whitespace-nowrap transition-all duration-500 group-hover:scale-110",r(a.value.type)])},O(c(a.value.type)),3)],2)]),s("div",wm,[s("div",null,[s("p",{class:w(["text-xs font-black uppercase tracking-[0.4em] mb-2 drop-shadow-sm",l(a.value.name)])},O(c(a.value.type)),3),s("h1",{class:w(["text-5xl md:text-7xl font-[1000] tracking-tighter italic uppercase leading-none mb-4 drop-shadow-2xl transition-all duration-500 brightness-100 saturate-70",l(a.value.type),e.isDark?"[-webkit-text-stroke:1px_white]":"[-webkit-text-stroke:1px_black]"]),style:{maskImage:"linear-gradient(to bottom, black 10%, rgba(0,0,0,0.5) 100%)",webkitMaskImage:"linear-gradient(to bottom, black 10%, rgba(0,0,0,0.5) 100%)"}},O(a.value.name),3),s("div",Pm,[h[4]||(h[4]=s("div",{class:"h-[3px] w-16 bg-cyan-500 shadow-[0_0_10px_rgba(6,182,212,0.8)]"},null,-1)),s("p",Mm,"System ID: #"+O(a.value.code),1)])]),s("div",{class:w(["p-8 md:p-12 rounded-[3rem] border-2 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)] backdrop-blur-3xl relative overflow-hidden transition-all hover:border-cyan-500/50",e.isDark?"bg-slate-900/80 border-white/10 shadow-black":"bg-white border-slate-200 shadow-slate-300"])},[h[5]||(h[5]=s("div",{class:"absolute top-0 right-0 p-8 text-8xl opacity-[0.05] grayscale pointer-events-none animate-spin-slow"},"✨",-1)),h[6]||(h[6]=s("h3",{class:"text-xs font-black uppercase tracking-[0.5em] text-slate-500 mb-8 flex items-center gap-3"},[s("span",{class:"w-2 h-2 bg-cyan-500 rounded-full animate-ping"}),Je(" Status/ Effect ")],-1)),s("div",Dm,[(T(!0),K($,null,me(m(a.value.view),(A,y)=>(T(),K("div",{key:y,class:"flex items-start gap-4 group/stat animate-fade-in",style:Pt({animationDelay:y*100+"ms"})},[A.includes("Dengan")?Ie("",!0):(T(),K("div",Rm)),s("p",{class:w(["text-base md:text-lg font-bold tracking-tight transition-colors",A.includes("Dengan")?"text-green-500 italic":A.includes("-")?"text-red-500":e.isDark?"text-slate-200 group-hover/stat:text-cyan-400":"text-slate-700"])},O(A),3)],4))),128))])],2),s("div",Sm,[p.value?(T(),K("div",{key:0,onClick:h[1]||(h[1]=A=>d(p.value.code)),class:w(["group p-6 rounded-[2.5rem] border-2 cursor-pointer transition-all duration-500 hover:-translate-y-2 shadow-xl",e.isDark?"bg-slate-900 border-white/5 hover:border-cyan-500/50 hover:shadow-cyan-900/20":"bg-white border-slate-200 hover:border-cyan-500 shadow-slate-200"])},[h[8]||(h[8]=s("p",{class:"text-[9px] font-black text-slate-500 uppercase tracking-widest mb-2"},"Previous Model",-1)),s("p",Cm,[h[7]||(h[7]=s("span",{class:"text-cyan-500 group-hover:-translate-x-2 transition-transform"},"←",-1)),Je(" "+O(p.value.name),1)])],2)):Ie("",!0),u.value?(T(),K("div",{key:1,onClick:h[2]||(h[2]=A=>d(u.value.code)),class:w(["group p-6 rounded-[2.5rem] border-2 cursor-pointer transition-all duration-500 hover:-translate-y-2 shadow-xl",e.isDark?"bg-slate-900 border-white/5 hover:border-purple-500/50 hover:shadow-purple-900/20":"bg-white border-slate-200 hover:border-purple-500 shadow-slate-200"])},[h[10]||(h[10]=s("p",{class:"text-[9px] font-black text-slate-500 uppercase tracking-widest mb-2"},"Advanced Upgrade",-1)),s("p",Em,[Je(O(u.value.name)+" ",1),h[9]||(h[9]=s("span",{class:"text-purple-500 group-hover:translate-x-2 transition-transform"},"→",-1))])],2)):Ie("",!0)])])])])):(T(),K("div",Tm,[...h[11]||(h[11]=[s("div",{class:"relative w-24 h-24"},[s("div",{class:"absolute inset-0 border-4 border-cyan-500/20 rounded-full"}),s("div",{class:"absolute inset-0 border-4 border-t-cyan-500 rounded-full animate-spin"})],-1)])]))],2))}},Km=Vt(_m,[["__scopeId","data-v-5b64479f"]]),Im={"Base Stats":[{label:"STR / STR%",value:"STR"},{label:"INT / INT%",value:"INT"},{label:"DEX / DEX%",value:"DEX"},{label:"AGI / AGI%",value:"AGI"},{label:"VIT / VIT%",value:"VIT"}],"ATK & DEF":[{label:"ATK / ATK%",value:".ATK"},{label:"MATK / MATK%",value:"MATK"},{label:"DEF / DEF%",value:".DEF"},{label:"MDEF / MDEF%",value:"MDEF"}],"Stability, Accuracy, Dodge":[{label:"Stability",value:"Stability"},{label:"Akurasi",value:"Akurasi"},{label:"Dodge",value:"Dodge"}],Critical:[{label:"Critical Rate / CR%",value:"Critical Rate"},{label:"Critical Damage / CD%",value:"Critical Damage"}],Speed:[{label:"ASPD / ASPD%",value:"ASPD"},{label:"CSPD / CSPD%",value:"CSPD"},{label:"Motion Speed%",value:"Motion Speed"}],"HP & MP":[{label:"MaxHP / MaxHP%",value:"MaxHP"},{label:"MaxMP / MaxMP%",value:"MaxMP"},{label:"Natural MP Regen%",value:"Natural MP Regen"},{label:"Natural HP Regen%",value:"Natural HP Regen"},{label:"Attack MP Recovery / AMPR%",value:"Attack MP Recovery"}],"Weapon ATK & Element":[{label:"Weapon ATK%",value:"Weapon ATK"},{label:"DTE (Elements)%",value:"stronger against"}],"Element Resistance":[{label:"Phys Resistance%",value:"Kekebalan Fisik"},{label:"Magic Resistance%",value:"Kekebalan Sihir"},{label:"Light Resistance%",value:"kebal Cahaya"},{label:"Dark Resistance%",value:"kebal Gelap"},{label:"Earth Resistance%",value:"kebal Bumi"},{label:"Fire Resistance%",value:"kebal Api"},{label:"Water Resistance%",value:"kebal Air"},{label:"Wind Resistance%",value:"kebal Angin"}],"Barrier & Defense Effect":[{label:"Fractional Barrier%",value:"Pelindung Fraksional"},{label:"Ailment Resistance%",value:"Resistansi Status Buruk"},{label:"Aggro%",value:"Aggro"}],"Offensive Effect":[{label:"Physical Pierce%",value:"Physical Pierce"},{label:"Magic Pierce%",value:"Peneterasi Sihir"},{label:"Short Range Dmg%",value:"Daya Jarak Dekat"},{label:"Long Range Dmg%",value:"Daya Jarak Jauh"},{label:"Unsheathe Attack%",value:"Serangan Menghunus"},{label:"Additional Melee%",value:"Tambahan Fisik"},{label:"Additional Magic%",value:"Tambahan Sihir"},{label:"Antisipasi%",value:"Antisipasi"},{label:"Guard Break%",value:"Guard Break"}],"Reduce DMG":[{label:"Reduksi DMG (Sekitar Pemain)%",value:"Reduksi DMG (Sekitar Pemain)"},{label:"Reduksi DMG (Sekitar Musuh)%",value:"Reduksi DMG (Sekitar Musuh)"},{label:"Reduksi DMG (Lantai)%",value:"Reduksi DMG (Lantai)"},{label:"Reduksi DMG (Linear)%",value:"Reduksi DMG (Linear)"},{label:"Reduksi DMG (Bowling)%",value:"Reduksi DMG (Bowling)"},{label:"Reduksi DMG (Terjang)%",value:"Reduksi DMG (Terjang)"},{label:"Reduksi DMG (Peluru)%",value:"Reduksi DMG (Peluru)"}],"Other Stat":[{label:"Drop Rate%",value:"Drop Rate"},{label:"EXP%",value:"EXP"},{label:"Revive Time%",value:"Revive Time"},{label:"Tumble Unavailable%",value:"Tumble Unavailable"},{label:"Evasion Recharge%",value:"Evasion Recharge"},{label:"Refleks%",value:"Refleks"},{label:"Recoil%",value:"Recoil"}]},Ql={"Base Stats":{text:"text-orange-400",border:"border-orange-500/30",accent:"text-orange-500 focus:ring-orange-500"},"ATK & DEF":{text:"text-cyan-400",border:"border-cyan-500/30",accent:"text-cyan-500 focus:ring-cyan-500"},"Stability, Accuracy, Dodge":{text:"text-blue-400",border:"border-blue-500/30",accent:"text-blue-500 focus:ring-blue-500"},Critical:{text:"text-red-400",border:"border-red-500/30",accent:"text-red-500 focus:ring-red-500"},Speed:{text:"text-pink-400",border:"border-pink-500/30",accent:"text-pink-500 focus:ring-pink-500"},"HP & MP":{text:"text-emerald-400",border:"border-emerald-500/30",accent:"text-emerald-500 focus:ring-emerald-500"},"Weapon ATK & Element":{text:"text-yellow-400",border:"border-yellow-500/30",accent:"text-yellow-500 focus:ring-yellow-500"},"Element Resistance":{text:"text-amber-500",border:"border-amber-500/30",accent:"text-amber-500 focus:ring-amber-500"},"Barrier & Defense Effect":{text:"text-green-500",border:"border-green-500/30",accent:"text-green-500 focus:ring-green-500"},"Offensive Effect":{text:"text-indigo-400",border:"border-indigo-500/30",accent:"text-indigo-500 focus:ring-indigo-500"},"Reduce DMG":{text:"text-teal-400",border:"border-teal-500/30",accent:"text-teal-500 focus:ring-teal-500"},"Other Stat":{text:"text-purple-400",border:"border-purple-500/30",accent:"text-purple-500 focus:ring-purple-500"}},Bm=[{label:"Weapon Crystas",value:"WEAPON",icon:Ei,color:"red"},{label:"Weapon Enhancer Crystas",value:"WEAPON_UPGRADE",icon:Ii,color:"red"},{label:"Armor Crystas",value:"ARMOR",icon:_i,color:"green"},{label:"Armor Enhancer Crystas",value:"ARMOR_UPGRADE",icon:Bi,color:"green"},{label:"Additional Crystas",value:"ADDITIONAL",icon:Ti,color:"yellow"},{label:"Additional Enhancer Crystas",value:"ADDITIONAL_UPGRADE",icon:Ni,color:"yellow"},{label:"Normal Crystas",value:"NORMAL",icon:Un,color:"blue"},{label:"Normal Enhancer Crystas",value:"NORMAL_UPGRADE",icon:Hn,color:"blue"},{label:"Special Crystas",value:"SPECIAL",icon:Ki,color:"pink"},{label:"Special Enhancer Crystas",value:"SPECIAL_UPGRADE",icon:Oi,color:"pink"}],Nm={class:"max-w-[1600px] mx-auto mb-6 flex items-center justify-between"},Om={class:"max-w-[1600px] mx-auto mb-12 flex flex-col lg:flex-row lg:items-end justify-between gap-8"},Lm={class:"text-5xl md:text-7xl font-[1000] tracking-tighter uppercase italic leading-[0.8]"},Gm={class:"text-2xl md:text-2xl font-[100] tracking-tighter uppercase italic leading-[0.8]"},Um={class:"max-w-[1600px] mx-auto space-y-5"},Hm={class:"grid grid-cols-4 md:grid-cols-6 lg:grid-cols-8 xl:grid-cols-10 gap-4"},jm=["onClick"],Fm=["src","alt"],Vm={key:0,class:"absolute top-4 right-6 w-2 h-2 bg-white rounded-full animate-pulse shadow-[0_0_10px_white]"},Jm={class:"flex items-center gap-1 mb-4 ml-2"},Wm={class:"grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-7 gap-2"},Qm=["onClick"],qm={class:"flex items-start justify-between gap-2 mb-4"},zm={key:0,class:"w-4 h-4 text-white",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},$m={class:"flex gap-1"},Xm=["onUpdate:modelValue"],Zm=["onUpdate:modelValue"],Ym=["onUpdate:modelValue"],eg={__name:"XtallAdvancedSearch",props:{isDark:Boolean},setup(e){const t=Wn(),n=Sa(),a=bn({stats:{},types:[]});tn(()=>{if(n.query.filter)try{const p=JSON.parse(n.query.filter);p?.stats&&(a.stats=p.stats),p?.types&&(a.types=p.types)}catch{console.warn("Invalid filter data")}});function i(){t.back()}function l(){Object.keys(a.stats).forEach(p=>delete a.stats[p]),a.types=[]}function o(p){a.stats[p]?delete a.stats[p]:a.stats[p]={sign:"+",op:">=",value:null}}function r(p){const u=a.types.indexOf(p);u>-1?a.types.splice(u,1):a.types.push(p)}function c(){t.push({name:"xtall",query:{filter:JSON.stringify(a)}})}return(p,u)=>(T(),K("div",{class:w(["p-4 md:p-8 font-sans transition-all duration-700 min-h-screen",e.isDark?"bg-[#050505] text-white":"bg-slate-50 text-slate-900"])},[s("div",Nm,[s("button",{onClick:i,class:"group flex items-center gap-3 px-4 py-2 rounded-xl transition-all hover:bg-white/5 active:scale-95"},[s("div",{class:w(["w-10 h-10 rounded-full flex items-center justify-center border-2 transition-all",e.isDark?"border-white/10 group-hover:border-orange-500/50 group-hover:bg-orange-500/10":"border-slate-200 group-hover:border-orange-500/50 group-hover:bg-orange-50"])},[...u[1]||(u[1]=[s("svg",{xmlns:"http://www.w3.org/2000/svg",class:"w-5 h-5 transition-transform group-hover:-translate-x-1",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},[s("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"3",d:"M15 19l-7-7 7-7"})],-1)])],2),u[2]||(u[2]=s("span",{class:"text-[11px] font-[1000] uppercase tracking-[0.2em] opacity-80 group-hover:opacity-100"},"Back",-1))])]),s("div",Om,[s("div",null,[s("h1",Lm,[s("span",{class:w(e.isDark?"text-white":"text-black")},"Advanced",2),u[3]||(u[3]=s("br",null,null,-1)),u[4]||(u[4]=s("span",{class:"bg-gradient-to-r from-orange-500 via-red-500 to-yellow-500 bg-clip-text text-transparent animate-gradient-x"},"Search",-1))]),s("h2",Gm,[u[5]||(u[5]=s("br",null,null,-1)),s("span",{class:w(e.isDark?"text-white":"text-black")},"All Flat and percent(%) stats are combined ",2),u[6]||(u[6]=s("br",null,null,-1))])]),s("div",{class:"flex flex-row items-center gap-4 w-full lg:w-auto"},[s("button",{onClick:l,class:"flex-1 lg:flex-none px-8 py-5 rounded-2xl font-black uppercase tracking-widest text-[10px] bg-red-500/10 text-red-500 border-2 border-red-500/20 hover:bg-red-500 hover:text-white transition-all duration-300"}," Clear Page "),s("button",{onClick:c,class:"flex-[2] lg:flex-none px-10 py-5 bg-orange-600 rounded-2xl transition-all duration-500 hover:scale-105 active:scale-95 shadow-[0_15px_40px_rgba(234,88,12,0.3)]"},[...u[7]||(u[7]=[s("span",{class:"text-xs font-[1000] uppercase tracking-[0.2em] text-white"},"Apply Parameters",-1)])])])]),s("div",Um,[s("section",null,[u[8]||(u[8]=s("div",{class:"flex items-center gap-3 mb-8 ml-2"},[s("div",{class:"w-1.5 h-6 rounded-full bg-cyan-500"}),s("h2",{class:"text-lg font-[1000] uppercase tracking-[0.3em] italic text-cyan-500"},"Type Crysta")],-1)),s("div",Hm,[(T(!0),K($,null,me(We(Bm),d=>(T(),K("div",{key:d.value,onClick:m=>r(d.value),class:w(["group relative p-5 rounded-[2.5rem] border-2 cursor-pointer transition-all duration-500 flex flex-col items-center gap-4 min-h-[160px] justify-center",a.types.includes(d.value)?"bg-[#468FE0] border-cyan-400 shadow-xl shadow-cyan-600/80 scale-[1.12]":e.isDark?"bg-[#0a0a0a] border-white/5 hover:border-white/20":"bg-white border-slate-100 shadow-sm hover:border-slate-300"])},[s("div",{class:w(["w-16 h-16 rounded-full overflow-hidden border-2 transition-all duration-500 group-hover:rotate-6 group-hover:scale-110 shadow-inner",a.types.includes(d.value)?"border-white shadow-lg":"border-slate-800/50"])},[s("img",{src:d.icon,class:"w-full h-full object-cover",alt:d.label},null,8,Fm)],2),s("span",{class:w(["text-[10px] font-black uppercase tracking-[0.15em] text-center leading-tight transition-colors",a.types.includes(d.value)?"text-white":e.isDark?"text-slate-400":"text-slate-500"])},O(d.label),3),a.types.includes(d.value)?(T(),K("div",Vm)):Ie("",!0)],10,jm))),128))])]),(T(!0),K($,null,me(We(Im),(d,m)=>(T(),K("div",{key:m},[s("div",Jm,[s("div",{class:w(["w-1.5 h-6 rounded-full",We(Ql)[m]?.bg||"bg-slate-500"])},null,2),s("h2",{class:w(["text-lg font-[1000] uppercase tracking-[0.3em] italic",We(Ql)[m]?.text||"text-slate-500"])},O(m),3)]),s("div",Wm,[(T(!0),K($,null,me(d,b=>(T(),K("div",{key:b.value,onClick:v=>o(b.value),class:w(["group/item relative rounded-[2rem] border-2 p-2 cursor-pointer transition-all duration-500 flex flex-col justify-between min-h-[70px]",a.stats[b.value]?e.isDark?"bg-orange-600/20 border-orange-500 shadow-lg shadow-orange-500/20":"bg-orange-50 border-orange-500":e.isDark?"bg-[#0a0a0a] border-white/5 hover:border-white/20":"bg-white border-slate-100 hover:border-slate-300 shadow-sm"])},[s("div",qm,[s("span",{class:w(["text-[11px] font-[1000] uppercase leading-tight tracking-wide transition-colors",a.stats[b.value]?e.isDark?"text-white":"text-orange-600":e.isDark?"text-slate-500":"text-slate-400"])},O(b.label),3),s("div",{class:w(["shrink-0 w-8 h-8 rounded-xl border flex items-center justify-center transition-all duration-500",a.stats[b.value]?"bg-orange-500 border-orange-400 rotate-0":e.isDark?"bg-white/5 border-white/10 rotate-45":"bg-slate-50 border-slate-200 rotate-45"])},[a.stats[b.value]?(T(),K("svg",zm,[...u[9]||(u[9]=[s("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"4",d:"M5 13l4 4L19 7"},null,-1)])])):(T(),K("div",{key:1,class:w(["text-lg leading-none",e.isDark?"text-white/20":"text-slate-300"])},"+",2))],2)]),xe(co,{name:"fade"},{default:Ye(()=>[a.stats[b.value]?(T(),K("div",{key:0,onClick:u[0]||(u[0]=Wc(()=>{},["stop"])),class:"space-y-2 mt-auto pt-4 border-t border-orange-500/20"},[s("div",$m,[ve(s("select",{"onUpdate:modelValue":v=>a.stats[b.value].sign=v,class:w(["flex-1 py-2.5 rounded-xl text-center font-black text-[10px] outline-none border transition-colors",e.isDark?"bg-black border-white/10 text-orange-400":"bg-white border-slate-200 text-orange-600"])},[...u[10]||(u[10]=[s("option",{value:"+"},"Stats +",-1),s("option",{value:"-"},"Stats -",-1)])],10,Xm),[[it,a.stats[b.value].sign]]),ve(s("select",{"onUpdate:modelValue":v=>a.stats[b.value].op=v,class:w(["flex-1 py-2.5 rounded-xl text-center font-black text-[10px] outline-none border transition-colors",e.isDark?"bg-black border-white/10 text-cyan-400":"bg-white border-slate-200 text-cyan-600"])},[...u[11]||(u[11]=[s("option",{value:">="},"≥",-1),s("option",{value:"<="},"≤",-1)])],10,Zm),[[it,a.stats[b.value].op]])]),ve(s("input",{type:"number","onUpdate:modelValue":v=>a.stats[b.value].value=v,class:w(["w-full py-2.5 rounded-xl text-center font-black text-[10px] outline-none border transition-all focus:border-orange-500",e.isDark?"bg-black border-white/10 text-white":"bg-white border-slate-200 text-black"]),placeholder:"VALUE"},null,10,Ym),[[ze,a.stats[b.value].value,void 0,{number:!0}]])])):Ie("",!0)]),_:2},1024)],10,Qm))),128))])]))),128))])],2))}},tg=Vt(eg,[["__scopeId","data-v-1f142105"]]),ng=[{path:"/",name:"bag",component:dd},{path:"/mq",name:"mainquest",component:Fd},{path:"/mq-calc",name:"mqcalc",component:Ef},{path:"/bs-calc",name:"bs-calc",component:gm},{path:"/xtall",name:"xtall",component:Gp},{path:"/xtall/advanced",name:"xtall-advanced",component:tg},{path:"/xtall/:id(\\d+)",name:"xtall-detail",component:Km,props:!0}],ag=i0({history:Nu("/toram-vue/"),routes:ng});document.title||(document.title="Timi DB | Toram Online Database");const Po=zc(b0);Po.use(ag);Po.mount("#app");window.addEventListener("unhandledrejection",e=>{console.warn("Ignored async listener error:",e.reason)});
